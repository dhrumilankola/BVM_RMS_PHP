   ...
   //               }
       $query	= mysqli_query($link, "SELECT * FROM user WHERE  pass='$password' and email='$email' and user_type='$user_type'");
			...
			if ($num_row > 0) 
              ...
              if($user_type=='Admin'){
      					 header('location:/rms-sir/admin/index.php');
                }
                else if($user_type=='Faculty'){
                   header('location:/rms-sir/Faculty/index.php');
                }
                else if($user_type=='Principal'){
                   header('location:/rms-sir/Principal/index.php');
                }
                else if($user_type=='HOD'){
                   header('location:/rms-sir/HOD/index.php');
                }
                else
                {

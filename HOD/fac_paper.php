      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
               		<h3 style="align-self: center;margin-top: 1%"><?php echo $rows['title']?></h3>
                            <div class="card-body">
                          <div class="row">
                            <div class="col-sm-12">
                              <form role="form">
                            ...
                            <tbody>
                                    <tr>
                                       ...
                                       <td style="width:30%">
                                        	<?php echo $rows['cj_name']; ?>
                                          <!-- <label>10th</label> -->
                                          </td>
                                          <td style="width:30%">
                                        	<?php echo $rows['paper_type']; ?>
                                          <!-- <label>10th</label> -->
                                          </td>
										  <td style="width:30%">
                                        	<?php echo $rows['yp']; ?>
                                         ...
                                         $row_did=mysqli_fetch_array($sqld);
                                          ?>
                                            <?php 
                                          echo $rows['pdf']."&nbsp&nbsp&nbsp";

                                           if($row_user['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$row_did['department']."/".$row_user['uname']."/".date('Y')."/Papers/Documents/".$rows['pdf']."' download='".$rows['pdf']."'><i class='fa fa-download'></i></a>";
                                          }
                                             
                                              else 
                                                echo $row_user['user_type'] ;
                                                ?>
                                                <!-- <a class='btn btn-info btn-sm' href="../Faculty/<?php $row_did['department']?>/<?php $row_user['uname']?>/<?php date('Y')?>/Books/Documents/<?php $rows['docc']?>" download="<?php echo $rows['docc'];?>"><i   class='fa fa-download'></i></a> -->
                                           <!--  <a class='btn btn-info btn-sm' href="../admin/Books/<?php date('Y')?>/<?php $rows['docc']?>" download="<?php echo $rows['docc'];?>"><i class='fa fa-download'></i></a> -->

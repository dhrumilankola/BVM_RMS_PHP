            ...
            <div class="card card-secondary">
              ...
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM reserch_proj where aid IN (select aid from user where did = '$row[did]') ";
                      if($result = mysqli_query($link, $sql)){
                      if(mysqli_num_rows($result) > 0){ 

                       ?>
                      <table id="vrprojects"  class="table table-bordered projects">
                        <thead>
                              <tr>
                              <th>A_Y</th>
							  <th > Name</th>                              
                            ...
                            echo "<td>" . $row1['a_y'].'-' .$row1['e_y'] . "</td>";
                             echo "<td>" . $row1['project_name'] . "</td>";
                              ...
                              <td class="project-actions text-left">
                               ...
                               <!--  <a class="btn btn-info btn-sm" href="aresearch_proj.php?projectid=<?php echo $row1['projectid']?>"><i class="fas fa-pencil-alt"></i></a>

      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
               		<h3 style="align-self: center;margin-top: 1%"><?php echo $rows['industry_name']?></h3>
                            <div class="card-body">
                          <div class="row">
                            <div class="col-sm-12">
                              <form role="form">
                            ...
                            <tbody>
                                    <tr>
                                       ...
                                       <td style="width:30%">
                                        	<?php echo $rows['ind_city']; ?>
                                          <!-- <label>10th</label> -->
                                          </td>
                                          <td style="width:30%">
                                        	<?php echo $rows['ind_state']; ?>
                                          <!-- <label>10th</label> -->
                                          </td>
                                          <td style="width:30%">
                                        	<?php echo $rows['sem']; ?>
                                     ...
                                     echo "<img src = '../Faculty/".$row_did['department']."/".$row_user['uname']."/".date('Y')."/IndustryVisit/Photos/". $rows['photos'] . "'class='img-responsive' style=width:100px;>"; ?></td> 
                                       <td><?php echo "<a class='btn btn-info btn-sm' href='../Faculty/".$row_did['department']."/".$row_user['uname']."/".date('Y')."/IndustryVisit/Photos/".$rows['photos']."' download='".$rows['photos']."'><i class='fa fa-download'></i></a>"; 	
											?>
                                          </td>

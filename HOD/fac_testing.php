     ...
     if($result = mysqli_query($link, $sql)){
            ...
            if(mysqli_num_rows($result) == 1){
				...
				$decr=$rows['decr'];
					...
					$timestamp = strtotime($rows['startdate']);
							$sdate = date("d-m-Y",$timestamp );
							$timestamp = strtotime($rows['enddate']);
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
               		<h3 style="align-self: center;margin-top: 1%"><?php echo $rows['project_name']?></h3>
                            <div class="card-body">
                          <div class="row">
                            <div class="col-sm-12">
                              <form role="form">
                            ...
                            <tbody>
                                    <tr>
                                      ...
                                      //echo "<img src = '../Faculty/".$row_did['department']."/".$row_user['uname']."/".date('Y')."/Projects/Documents/". $rows['upload'] . "'class='img-responsive' style=width:100px;>";
                                        	?>
											<?php 
                                          echo $rows['upload']."&nbsp&nbsp&nbsp";

                                           if($row_user['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$row_did['department']."/".$row_user['uname']."/".date('Y')."/Testing_Consultancy/Documents/".$rows['upload']."' download='".$rows['upload']."'><i class='fa fa-download'></i></a>";
                                          }

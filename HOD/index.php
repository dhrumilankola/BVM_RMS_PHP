...
<head>
  ...
  <title>BRMS |HOD  Dashboard</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">HOD Dashboard</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-lg-4 col-7">
            ...
            <div class="small-box" style="background-color: #ffa200; color: white">
              <div class="inner">
                <h3><?php $sql=mysqli_query($link,"select count(*) as c from conference where aid IN (select aid from user where did = '$row[did]')");
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box" style="background-color: #324867; color: white">
              <div class="inner">
                <h3><?php $sql=mysqli_query($link,"select count(*) as c from seminars where aid IN (select aid from user where did = '$row[did]')");
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box" style="background-color: #99004d; color: white">
              <div class="inner">
                <h3><?php $sql=mysqli_query($link,"select count(*) as c from ind_visit where aid IN (select aid from user where did = '$row[did]')");
                   while ($rconf=mysqli_fetch_array($sql)) {
                        echo $rconf['c'];
                    } 
                ?></h3>
           ...
           <div class="col-lg-4 col-6">
            ...
            <div class="small-box" style="background-color: #3b6e78; color: white">
              <div class="inner">
                <h3><?php $sql=mysqli_query($link,"select count(*) as c from book where aid IN (select aid from user where did = '$row[did]')");
                   while ($rconf=mysqli_fetch_array($sql)) {
                        echo $rconf['c'];
                    } 
           ...
           <div class="col-lg-4 col-6">
            ...
            <div class="small-box" style="background-color: #4169E1; color: white">
              <div class="inner">
                <h3><?php $sql=mysqli_query($link,"select count(*) as c from papers where aid IN (select aid from user where did = '$row[did]')");
                   while ($rconf=mysqli_fetch_array($sql)) {
                        echo $rconf['c'];
                    } 
		  ...
		  <div class="col-lg-4 col-6">
            ...
            <div class="small-box" style="background-color: #FF6347; color: white">
              <div class="inner">
                <h3><?php $sql=mysqli_query($link,"select count(*) as c from sttp_fdp where aid IN (select aid from user where did = '$row[did]')");
                   while ($rconf=mysqli_fetch_array($sql)) {
                        echo $rconf['c'];
                    } 
                ?></h3>
		  ...
		  <div class="col-lg-4 col-6">
            ...
            <div class="small-box" style="background-color: #CD853F; color: white">
              <div class="inner">
                <h3><?php $sql=mysqli_query($link,"select count(*) as c from workshop where aid IN (select aid from user where did = '$row[did]')");
                   while ($rconf=mysqli_fetch_array($sql)) {
                        echo $rconf['c'];
                    } 
                ?></h3>
		  ...
		  <div class="col-lg-4 col-6">
            ...
            <div class="small-box" style="background-color: #8FBC8B; color: white">
              <div class="inner">
                <h3><?php $sql=mysqli_query($link,"select count(*) as c from testing where aid IN (select aid from user where did = '$row[did]')");
                   while ($rconf=mysqli_fetch_array($sql)) {
                        echo $rconf['c'];
                    } 
                ?></h3>
		  ...
		  <div class="col-lg-4 col-6">
            ...
            <div class="small-box" style="background-color: #48D1CC; color: white">
              <div class="inner">
                <h3><?php $sql=mysqli_query($link,"select count(*) as c from patent where aid IN (select aid from user where did = '$row[did]')");
                   while ($rconf=mysqli_fetch_array($sql)) {
                        echo $rconf['c'];
                    } 
                ?></h3>
           ...
           <div class="col-lg-4 col-6">
            ...
            <div class="small-box" style=" background-color: #A52A2A; color: white">
              <div class="inner"> 
                <h3><?php $sql=mysqli_query($link,"select count(*) as c from reserch_proj where  aid IN (select aid from user where did = '$row[did]')");
                   while ($rconf=mysqli_fetch_array($sql)) {
                        echo $rconf['c'];
                    } 
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box" style=" background-color: #C70039  ; color: white">
              <div class="inner"> 
                <h3><?php $sql=mysqli_query($link,"select count(*) as c from user where  aid IN (select aid from user where did = '$row[did]')");
                   while ($rconf=mysqli_fetch_array($sql)) {
                        echo $rconf['c'];
                    } 

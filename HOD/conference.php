...
<head>
  ...
  <title>BRMS |HOD View Conference</title>
                      ...
                      <table id="vconference"  class="table table-bordered projects">
                          ...
                          <tr col-span="2">
                               ...
                               <td><?php $img=explode("|",$row1['photos']);
                                   ...
                                   {
                                   echo "<img height='20%' width='20%' src='../admin/Conference/".date('Y')."/$img[$i]'/>";
                                    }
                                    elseif($row2['user_type'] == 'Faculty')
                                    {
                                        echo "<img height='30%' width='80%' src='../Faculty/".$rowdid['department']."/".$row2['uname']."/".date('Y')."/Conference/Photos/$img[$i]' />";
                                    }
                                  }
                                     ?>
                            </td></tr>

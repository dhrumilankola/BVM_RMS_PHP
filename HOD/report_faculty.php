...
$result1=mysqli_query($link,"SELECT * FROM user WHERE aid='$staff'")or die('Error In Session');
...
$pdf->Cell(120);
$pdf->Cell(140,5,"HOD, ".$rowdid['department'].''.  " ".''."Department",0,1,'C');
$pdf->Cell(120);
//output the pdf
$pdf->Output();
		}
...
$pdf->SetFont('Arial','',14);
$pdf->Cell(40,5,"Reserch Projects Details",0,0,'C');
...
<head>
  ...
  <title>BRMS|HOD View Staff Report</title>
    ...
    <section class="content">
      <div class="container-fluid">
		...
		function frmselect(){				
			...
			if(madestaff(staff, "Please Select Faculty Name ")){
			if(madework(work, "Please Select Work Type ")){	
									return true;
								}
							}
		...
		function madestaff(elem, helperMsg){
			if(elem.value == "Select Faculty Name"){
				alert(helperMsg);
				elem.focus();
				return false;
			}else{
		...
		function madework(elem, helperMsg){
			if(elem.value == "Select Work"){
				alert(helperMsg);
				elem.focus();
				return false;
			}else{
              ...
              <div class="card-body">
                ...
                <div class="row">
                    ...
                    <input type="date" class="form-control" placeholder="Enter ..." name="fromdate"  required>
                    </div>
                </div>
                 <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <label>To Date</label>
                      <input type="date" class="form-control" placeholder="Enter ..." name="todate"  required>
                    </div>
                </div>
                 <div class="col-sm-3">
                          <div class="form-group">
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                       <label>Select Work</label>
                           <select name="user_work" class="form-control" id="work" required >
                              <!-- <option>Select </option> -->
							   <option value="Select Work">Select Work</option>
               ...
               <!--  <div class="col-sm-4">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-1.2">
                    <div class="col-sm-12">
                    <button type="submit" class="btn btn-info float-right"  name="csv"  value="csv"><i class="fas fa-file-csv"></i></i> &nbsp Export</button>
					<button type="submit" class="btn btn-success float-right" name="Export" style="margin-right:650px;"  value="Export" target="_blank"><i class="fas fa-print"></i> &nbsp Print</button>

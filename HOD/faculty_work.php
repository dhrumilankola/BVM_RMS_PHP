...
$pdf->Cell(120);
//$pdf->Cell(140,5,$rowdid['department'].''.  " ".''."Department",0,1,'C');
//output the pdf
$pdf->Output();
		}
              ...
              <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" placeholder="Enter ..." name="fromdate" id="fromdate" required >
                    </div>
                </div>
                 <div class="col-sm-4">
                    <div class="form-group">
                      <label>To Date</label>
                      <input type="date" class="form-control" placeholder="Enter ..." name="todate" id="todate" required >

...
<head>
  ...
  <title>BRMS|HOD View Industrial Visit</title>
            ...
            <div class="card card-secondary">
              ...
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM ind_visit where aid IN (select aid from user where did = '$row[did]') " ;
                            ...
                            echo "<td >" . $new_date . "</td>";
                             ...
                             elseif($row2['user_type']=='Admin'){
                              ...
                              <td class="project-actions text-left">
                               ...
                               <!--  <a class="btn btn-info btn-sm" href="aind_visit.php?id=<?php echo $row1['id']?>"><i class="fas fa-pencil-alt"></i></a>

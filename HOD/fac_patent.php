                                      ...
                                      //echo "<img src = '../Faculty/".$row_did['department']."/".$row_user['uname']."/".date('Y')."/Projects/Documents/". $rows['upload'] . "'class='img-responsive' style=width:100px;>";
                                          ...
                                          echo $rows['docc']."&nbsp&nbsp&nbsp";
                                           ...
                                           if($row_user['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$row_did['department']."/".$row_user['uname']."/".date('Y')."/Patent/Documents/".$rows['docc']."' download='".$rows['docc']."'><i class='fa fa-download'></i></a>";
                                          }

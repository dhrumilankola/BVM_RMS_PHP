                                       ...
                                       <td style="width:30%">
                                          ...
                                          //echo $rows['upload'];
                                           ...
                                           if($row_user['user_type'] == 'Faculty')
                                             { 
                                               echo "<img src = '../Faculty/".$row_did['department']."/".$row_user['uname']."/".date('Y')."/Sttp/Photos/". $rows['photos'] . "'class='img-responsive' style=width:100px;>";
											   echo "<a class='btn btn-info btn-sm' href='../Faculty/".$row_did['department']."/".$row_user['uname']."/".date('Y')."/Sttp/Photos/".$rows['photos']."' download='".$rows['photos']."'><i class='fa fa-download'></i></a>";
                                          }

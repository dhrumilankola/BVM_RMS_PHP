            ...
            <div class="card card-secondary">
              ...
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM papers where aid IN (select aid from user where did = '$row[did]') ";
                          ...
                          while($row1 = mysqli_fetch_array($result)){
                            ...
                            // echo" <iframe src='".$row['uname']."/Papers/".date('Y')."/". $row1['pdf'] . "'></iframe><br>";
                              ...
                              <td class="project-actions text-left" style="width:10%">
                                ...
                                <!-- <a class="btn btn-info btn-sm" href="apaper.php?paperid=<?php echo $row1['paperid']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deletepaper.php?paperid=<?php echo $row1['paperid']?>"><i class="fas fa-trash"></i></a> -->
                              <!-- </div> -->
                              </td>

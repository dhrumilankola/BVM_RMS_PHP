...
<head>
  ...
  <title>BRMS|HOD View Seminar</title>
            ...
            <div class="card card-secondary">
              ...
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM seminars where aid IN (select aid from user where did = '$row[did]') ";
                          ...
                          while($row1 = mysqli_fetch_array($result)){
                            ...
                            elseif($row2['user_type']=='Admin'){
                              ...
                              <td class="project-actions text-left">
                               ...
                               <!--  <a class="btn btn-info btn-sm" href="aseminar.php?semid=<?php echo $row1['semid']?>"><i class="fas fa-pencil-alt"></i></a>

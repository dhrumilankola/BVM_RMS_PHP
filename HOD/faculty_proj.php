                  ...
                  <div class="col-sm-1.2">
                   ...
                   <div class="col-sm-1.2">
                      ...
                      //     while($rowsem = mysqli_fetch_array($res_sem)){
                            ...
                            <tr>
                              <?php
                                  $sql1="select * from subjects where subid='$rowproj[subid]'";
                                       if($result1 = mysqli_query($link, $sql1)){
                                               while($row2 = mysqli_fetch_array($result1)){

                             $sql1="select * from user where aid='$rowproj[aid]'";
                                        if($result1 = mysqli_query($link, $sql1)){
                                           while($row3 = mysqli_fetch_array($result1)){
                             echo "<td>" . $rowproj['name'] . "</td>";
                              echo "<td>" . $row2['Name'] . "</td>";
                               echo "<td>" . $rowproj['fromdate'] . "</td>";    
                              echo "<td>" . $rowproj['todate'] . "</td>";
                              echo "<td class=col-md-0>" . $rowproj['decr'] . "</td>";

                             
                               echo "<td><img style=width:100px;height:80px; src='../Faculty/".$row3['uname']."/Projects/".date('Y')."/". $rowproj['upload']."'/></td>";

...
if(isset($_FILES['photos'])){
  ...
  foreach($_FILES['photos']['tmp_name'] as $key => $tmp_name ){
    ...
    if($row3['user_type'] == "Admin"){  
         $desired_dir='../admin/Conference/'.date('Y');
        ...
        if(empty($errors)==true){
            ...
            if(is_dir("$desired_dir/".$file_name)==false){
                move_uploaded_file($file_tmp,'../admin/Conference/'.date('Y')."/".$file_name);
            }else{                  //rename the file if another one exist
                $new_dir='../admin/Conference/'.date('Y')."/".$file_name.time();
    ...
    $rowdid=mysqli_fetch_array($sqldid);
         $desired_dir="../Faculty/".$rowdid['department']."/".$row3['uname']."/".date('Y')."/Conference/Photos";
        if(empty($errors)==true){
            if(is_dir($desired_dir)==false){
                mkdir("$desired_dir", 0700);    // Create directory if it does not exist
            }
            if(is_dir("$desired_dir/".$file_name)==false){
                move_uploaded_file($file_tmp,"../Faculty/".$rowdid['department']."/".$row3['uname']."/".date('Y')."/Conference/Photos/".$file_name);
            }else{  //rename the file if another one exist
                $new_dir="../Faculty/".$rowdid['department']."/".$row3['uname']."/".date('Y')."/Conference/Photos/".$file_name.time();
                rename($file_tmp,$new_dir) ;       
            }
        }
        else{
  ...
  if(empty($error)){
    ...
    $photos = implode("|", $imageData);
     $query= "UPDATE conference SET name='$name',attend_as='$as',type='$type',date='$date',decr='$decr',photos='$photos',start_time='$start_time',end_time='$end_time' WHERE conid='$conid'";
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                ...
                <div class="row">
                   <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      <label>Subject</label>
                      <input type="text" class="form-control" placeholder="Enter ..." name="name" value="<?php echo $rows['name'] ?>">
                    </div>
                  </div>
                   <div class="col-sm-4">
                              <!-- text input -->
                              <div class="form-group">
                                ...
                                <input type="text"  class="form-control" placeholder="Enter ..."name="decr" required  value="<?php echo $rows['decr'] ?>">
                  ...
                  <div class="col-sm-2">
                            <div class="form-group">
                                  ...
                                  <select class="form-control" name="as" value="<?php echo $rows['attend_as'] ?>">
                  ...
                  <div class="col-sm-2">
                            <div class="form-group">
                                  ...
                                  <select class="form-control" name="type" value="<?php echo $rows['type'] ?>">
                                    <option>Select here </option>
                  ...
                  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                ...
                                <input type="date"  class="form-control" name="date" required pattern="\Y{4}-\m{2}-\d{2}" value="<?php echo $rows['date'] ?>">
                                <!-- data-date-format="DD MMMM YYYY" -->
                              </div>
                  </div>
                   <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                ...
                                <input type="time"  class="form-control" name="start_time" required value="<?php echo $rows['start_time'] ?>">
                                <!-- data-date-format="DD MMMM YYYY" -->
                              </div>
                  </div>
                  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                ...
                                <input type="time"  class="form-control" name="end_time" required value="<?php echo $rows['end_time'] ?>">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="col-sm-12">
                    <input type="submit" class="btn btn-info" name="updateconf" value="submit">

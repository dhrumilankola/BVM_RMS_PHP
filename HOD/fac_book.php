      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
               		<h3 style="align-self: center;margin-top: 1%"><?php echo $rows['book_title']?></h3>
                            <div class="card-body">
                          <div class="row">
                            <div class="col-sm-12">
                              <form role="form">
                                          ...
                                          echo $rows['docc']."&nbsp&nbsp&nbsp";
                                           ...
                                           if($row_user['user_type'] == 'Faculty')
                                             { 
                                              ...
                                              elseif($row_user['user_type'] == 'Admin')
                                              {
                                                echo "<a class='btn btn-info btn-sm' href='../admin/Books/".date('Y')."/".$rows['docc']."' download=".$rows['docc']."><i class='fa fa-download'></i></a>";
                                              }
                                              else 

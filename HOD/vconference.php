...
<head>
  ...
  <title>BRMS | View Conference</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Conference Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM conference where aid IN (select aid from user where did = '$row[did]')";
                              ...
                              <td class="project-actions text-left">
                               ...
                               <!--  <a class="btn btn-info btn-sm" href="#"><i class="fas fa-share-alt"></i></a> -->
                                <!-- <a class="btn btn-primary btn-sm" href="#"><i class="fas fa-folder"></i></a> -->
                                 <a class="btn btn-info btn-sm" href="conference.php?conid=<?php echo $row1['conid']?>"><i class="fas fa-eye"></i></a>
                               <!--  <a class="btn btn-info" href="conference.php?conid=<?php echo $row1['conid']?>">View</a> -->
                                <!--  <a class="btn btn-info btn-sm" href="aconference.php?conid=<?php echo $row1['conid']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deleteconf.php?conid=<?php echo $row1['conid']?>"><i class="fas fa-trash"></i></a> -->
                              <!-- </div> -->
                              </td>

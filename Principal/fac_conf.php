                          ...
                          <div class="row">
                            ...
                            <tbody>
                                    <tr>
                                     ...
                                     echo "<img src = '../Faculty/".$row_did['department']."/".$row_user['uname']."/".date('Y')."/Conference/Photos/". $rows['photos'] . "'class='img-responsive' style=width:100px;>";
                                        	?>
                                          </td>
                                           <td><?php echo "<a class='btn btn-info btn-sm' href='../Faculty/".$row_did['department']."/".$row_user['uname']."/".date('Y')."/Conference/Photos/".$rows['photos']."' download='".$rows['photos']."'><i class='fa fa-download'></i></a>"; 	
											?>
                                          </td>
                                      </tr>
                            </tbody>

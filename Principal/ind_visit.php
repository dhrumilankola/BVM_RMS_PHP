            ...
            <div class="card card-secondary">
              ...
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM ind_visit where id=".$_GET['id'];
...
<!--                    Display Data -->                    
                      ...
                      <table id="vclient" class="table table-bordered projects">
                              ...
                              <tr>
                                  <th> ID</th><td><?php echo  $row1['id'] ?></td>
                            </tr>
                              <tr>
                                  <th >Date</th> <td><?php echo $row1['date']?></td>
                            </tr>
                            <tr>
                               <th >Ind. Name</th><td><?php echo  $row1['industry_name']  ?></td>
                            </tr>
                             <tr>
                                 <th >City</th><td><?php echo $row1['ind_city'] ?></td>
                            </tr>
                          <tr>
                                <th >State</th><td><?php echo $row1['ind_state'] ?></td>
                            </tr>
                             <tr>
                                  <th >Faculty Name</th><td><?php echo $row2['uname']  ?></td>
                            </tr>
                             <tr>
                                  <th >Semester</th><td><?php echo $row1['sem']  ?></td>
                            </tr>
                             <tr>
                                 <th >Students</th><td><?php echo $row1['noofstud'] ?></td>
                            </tr>
                            <!--  <tr>
                                <th >Photos</th><td><?php echo $row1['date'] ?></td>
                            </tr> -->
                           <tr col-span="2">
                               <th>Photos</th>
                               <td><?php $img=explode("|",$row1['photos']);
                                   ...
                                   {
                                        echo "<img height='10%' width='20%' src='../admin/IndustryVisit/".date('Y')."/$img[$i]'/>";
                                      } 
                                        elseif($row2['user_type'] == 'Faculty')
                                    {
                                      echo "<img height='60%' width='80%' src='../Faculty/".$rowdid['department']."/".$row2['uname']."/".date('Y')."/IndustryVisit/Photos/$img[$i]' />";
                                        }
                                      }
                                            ?>
                            </td></tr>

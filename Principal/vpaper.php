                      ...
                      <table id="vclient"  class="table table-bordered projects">
                        ...
                        <?php
                          while($row1 = mysqli_fetch_array($result)){
                            ...
                            echo "<td>" . $row1['fat'] . "</td>";
                            echo "<td>" . $row1['cj_name'] . "</td>";
							echo "<td>" . $row1['paper_type'] . "</td>";
							echo "<td>" . $row1['yp'] . "</td>";
							echo "<td>" . $row1['impact'] . "</td>";
							echo "<td>" . $row2['uname'] . "</td>";
                            // echo" <iframe src='".$row['uname']."/Papers/".date('Y')."/". $row1['pdf'] . "'></iframe><br>";
                           
                              
                              ?>
                              <td class="project-actions text-left" style="width:10%">
                                 <a class="btn btn-info btn-sm" href="paper.php?paperid=<?php echo $row1['paperid']?>"><i class="fas fa-eye"></i></a>
                                <?php 
                                          //echo $row1['pdf']."&nbsp&nbsp&nbsp";

                                           if($row2['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$rowdid['department']."/".$row2['uname']."/".date('Y')."/Papers/Documents/".$row1['pdf']."' download='".$row1['pdf']."'><i class='fa fa-download'></i></a>";
                                          }
										  elseif($row2['user_type']=='Admin')
                             {
                               echo "<a class='btn btn-info btn-sm' href='../admin/Papers/".date('Y')."/". $row1['pdf']. "' download='".$row1['pdf']."'><i class='fa fa-download'></i></a>";
                             }

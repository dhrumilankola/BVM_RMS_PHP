...
<head>
  ...
  <title>BRMS |Principal View Sttp |Fdp </title>
                          ...
                          <tr>
                           ...
                           <tr col-span="2">
                               ...
                               <td><?php $img=explode("|",$row1['photos']);
                                   ...
                                   {
                                        echo "<img height='20%' width='20%' src='../admin/Sttp/".date('Y')."/$img[$i]'/>";
                                      }
                                      elseif($row2['user_type'] == 'Faculty')
                                      {
                                        echo "<img height='30%' width='80%' src='../Faculty/".$rowdid['department']."/".$row2['uname']."/".date('Y')."/Sttp/Photos/$img[$i]' />";
                                      }

...
<head>
  ...
  <title>BRMS |Principal View Industrial Visit</title>
                         ...
                         $sql1="select * from user where aid='$row1[aid]'";
                            ...
                            echo "<td >" . $new_date . "</td>";
                             echo "<td>" . $row1['industry_name'] . "</td>";
                              ...
                              <?php 
                                          //echo $row1['pdf']."&nbsp&nbsp&nbsp";

                                           if($row2['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$rowdid['department']."/".$row2['uname']."/".date('Y')."/IndustryVisit/photos/".$row1['photos']."' download='".$row1['photos']."'><i class='fa fa-download'></i></a>";
                                          }

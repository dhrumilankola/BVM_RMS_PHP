...
<head>
  ...
  <title>BRMS |Principal View Book</title>
                              ...
                              <td class="project-actions text-left">
                                ...
                                <?php 
                                          //echo $row1['pdf']."&nbsp&nbsp&nbsp";
                                           ...
                                           if($row2['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$rowdid['department']."/".$row2['uname']."/".date('Y')."/Books/Documents/".$row1['docc']."' download='".$row1['docc']."'><i class='fa fa-download'></i></a>";
                                          }

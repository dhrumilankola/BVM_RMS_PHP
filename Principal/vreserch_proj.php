...
<head>
  ...
  <title>BRMS |Principal View Research Projects</title>
                        ...
                        <?php
                          while($row1 = mysqli_fetch_array($result)){                                  
                            ...
                            echo "<td>" . $row1['a_y'].'-' .$row1['e_y'] . "</td>";
                             ...
                             {
                               echo "<a class='btn btn-info btn-sm' href='../admin/Projects/".date('Y')."/". $row1['upload']. "' download='".$row1['upload']."'><i class='fa fa-download'></i></a>";
                             }

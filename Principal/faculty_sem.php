                   ...
                   <div class="col-sm-1.2">
                      ...
                      if(mysqli_num_rows($res_sem) > 0){ 
                          while($rowsem = mysqli_fetch_array($res_sem)){
                            ...
                            <tr>
                              <?php
                             $sql1="select * from user where aid='$rowsem[aid]'";
                                        if($result1 = mysqli_query($link, $sql1)){
                                           while($row2 = mysqli_fetch_array($result1)){
                             echo "<td>" . $rowsem['name'] . "</td>";
                              echo "<td>" . $rowsem['attend_as'] . "</td>";
                               echo "<td>" . $rowsem['type'] . "</td>"; 
                                 echo "<td>" . $row2['uname'] . "</td>";    
                              echo "<td>" . $rowsem['date'] . "</td>";
                              echo "<td class=col-md-0>" . $rowsem['start_time'] . "</td>";
                              echo "<td>" . $rowsem['end_time'] . "</td>";
                               echo "<td><img style=width:100px;height:80px; src='../Faculty/".$row2['uname']."/Conference/".date('Y')."/". $rowsem['photos'] . "'/></td>";

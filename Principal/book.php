...
<head>
  ...
  <title>BRMS |Principal View Book Details</title>
                         ...
                         <tr>
                          ...
                          <tr>
                           ...
                           <tr col-span="2">
                              ...
                              {    
                                echo "<iframe src='../Faculty/".$rowdid['department']."/". $row3['uname']."/".date('Y')."/Books/Documents/". $row1['docc']."' style=width:80%></iframe>";
                              }

                ...
                <div class="row">
                                     ...
                                     <?php
                                      ...
                                      ?>
                                       <input type="text" class="form-control" placeholder="Enter ..." name="did" value="<?php echo $department; ?>" readonly>
                                         <!--  <select class="form-control" name="department" value="<?php echo $did; ?>"> -->
                                      <?php
                                          // while ($row = mysqli_fetch_assoc($result)) {
                                          //   $department = $row['department'];
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter ..." name="desig" value="<?php echo $desig; ?>" readonly>
                     <!-- <?php
...
$rows['uname']."/Images/".$rows['profile']."'class='img-responsive' width='150' height='150'><br>";
                          ...
                          <td >
                            <?php if($rows['resume']!="") {
                             echo" <iframe src = './".$rowdid['department']."/".
$rows['uname']."/Resume/".$rows['resume']."'></iframe><br>";

...
//             }
        ...
        $desired_dir='Projects/'.date('Y')."/";
        if(empty($errors)==true){
            if(is_dir($desired_dir)==false){
                mkdir("$desired_dir", 0700);    // Create directory if it does not exist
            }
            if(is_dir("$desired_dir/".$file_name)==false){
                move_uploaded_file($file_tmp,'Projects/'.date('Y')."/".$file_name);
            }else{                  //rename the file if another one exist
                $new_dir='Projects/'.date('Y').$file_name.time();
      ...
      elseif($row3['user_type'] == "Faculty"){
        ...
        if(empty($errors)==true){
            ...
            if(is_dir("$desired_dir/".$file_name)==false){
                move_uploaded_file($file_tmp,"../Faculty/".$rowdid['department']."/".$row3['uname']."/".date('Y')."/Projects/Documents/".$file_name);
            }else{                  //rename the file if another one exist
                $new_dir="../Faculty/".$rowdid['department']."/".$row3['uname']."/".date('Y')."/Projects/Documents/".$file_name.time();
                 rename($file_tmp,$new_dir) ;       
            }
  ...
  if(empty($error)){
     $upload = implode("|", $imageData);
      $query= "UPDATE reserch_proj SET name='$name',subid='$subid',fromdate='$fromdate',todate='$todate',decr='$decr',upload='$upload' WHERE projectid='$projectid'";
...
<head>
  ...
  <title>Birla Vishvakarma Mahavidyalaya | Reserch Projects</title>
                  ...
                  <div class="col-sm-3">
                   ...
                   <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" placeholder="Enter ..." name="fromdate" value="<?php echo $fromdate;?>">
                    </div>
                </div>
                 <div class="col-sm-3">
                    <div class="form-group">
                      <label>To Date</label>
                      <input type="date" class="form-control" placeholder="Enter ..." name="todate" value="<?php echo $todate;?>">
                    </div>
                </div>
                  <div class="col-sm-3">
                <div class="form-group">
                    <label>Upload Project</label>
                   <input type="file" name="upload[]" class="btn btn-info btn-block file" value="<?php echo $upload;?>" multiple>
                 </div>
               </div>
               <div class="col-sm-6">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter ..." name="decr" value="<?php echo $decr;?>">
                    </div>
                  </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="col-sm-12">
                    <input type="submit" class="btn btn-info" name="updateproject" value="submit">

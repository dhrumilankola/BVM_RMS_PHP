                  ...
                  <div class="col-sm-1.2">
                   ...
                   <div class="col-sm-1.2">
                      ...
                      //     while($rowsem = mysqli_fetch_array($res_sem)){
                            ...
                            <tr>
                              <?php
                                $sql1="SELECT * FROM subjects where subid='$rowbook[subid]'";
                             if($result1 = mysqli_query($link, $sql1)){
                               while($row1 = mysqli_fetch_array($result1)){
                             $sql1="select * from user where aid='$rowbook[aid]'";
                                        if($result1 = mysqli_query($link, $sql1)){
                                           while($row2 = mysqli_fetch_array($result1)){
                             echo "<td>" . $rowbook['bookid'] . "</td>";
                            echo "<td style=width:10px>" . $rowbook['created_at'] . "</td>";
                             echo "<td>" . $rowbook['name'] . "</td>";
                              echo "<td>" . $row1['Name'] . "</td>";
                               echo "<td style=width:100px>" . $rowbook['total_pages'] . "</td>";    
                               echo "<td><img style=width:100px;height:80px; src='../Faculty/".$row2['uname']."/Books/".date('Y')."/". $rowbook['docc'] . "'/></td>";

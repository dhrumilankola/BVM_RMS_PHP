            ...
            <div class="card card-secondary">
              ...
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM conference where conid=".$_GET['conid'];
...
<!--                    Display Data -->                    
                      ...
                      <table id="vconference"  class="table table-bordered projects">
							 ...
							 <tr>
                                  <th>No_of_Days</th><td><?php echo $row1['nod'] ?></td>
                            </tr>
							 <tr>
                                  <th>Topic_Name</th><td><?php echo $row1['name'] ?></td>
                            </tr>		
							 ...
							 <tr>
                              ...
                              <tr>
                                  <th>Attend As</th><td><?php echo $row1['attend_as'] ?></td>
                            </tr>
                            <tr>
                          ...
                          <tr>
                             ...
                             <tr>
                                 <th> Download </th><td> <?php 
                                           ...
                                           if($row2['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$rowdid['department']."/".$row2['uname']."/".date('Y')."/Conference/photos/".$row1['photos']."' download='".$row1['photos']."'><i class='fa fa-download'></i></a>";
                                          }
                           ...
                           <tr col-span="2">
                               ...
                               // $sqldid=mysqli_query($link,"select * from Department WHERE did='$row[did]'");
                               //    $rowdid=mysqli_fetch_array($sqldid);
                                $img=explode("|",$row1['photos']);
                                    for($i = 0; $i < count($img); $i++){         
                              echo "<img height='10%' width='80%' src='".$rowdid['department']."/".$row2['uname']."/".date('Y')."/Conference/Photos/$img[$i]'/>";
                                } ?>
                            </td></tr>
                            <tr>

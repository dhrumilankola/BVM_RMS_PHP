...
<head>
  ...
  <title>BRMS |View Paper Details</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Published Paper Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM papers where paperid=".$_GET['paperid'];
                      if($result = mysqli_query($link, $sql)){
                      if(mysqli_num_rows($result) > 0){ 
                        while($row1 = mysqli_fetch_array($result)){
                            
                                  $sql2="select * from user where aid='$row1[aid]'";
                                        if($result2 = mysqli_query($link, $sql2)){
                                           while($row3 = mysqli_fetch_array($result2)){
                       ?>
                     <table id="vconference"  class="table table-bordered projects">
                         <tr>
                                 <th>Academic Year</th>   <td><?php echo $row1['a_y'].'-' .$row1['e_y']?></td>
                            </tr>
                         <tr>
						 <tr>
                                 <th>Paper Title</th>   <td><?php echo $row1['title']?></td>
                            </tr>
                         <tr>
						  <tr>
                                 <th>No of Author</th>   <td><?php echo $row1['no_at']?></td>
                            </tr>
						 <tr>
                                 <th>1st Author Name</th>   <td><?php echo $row1['fat']?></td>
                            </tr>
                         <tr>
						 <tr>
                                 <th>2nd Author Name</th>   <td><?php echo $row1['sat']?></td>
                            </tr>
                         <tr>
						 <tr>
                                 <th>3rd Author Name</th>   <td><?php echo $row1['tat']?></td>
                            </tr>
                         <tr>
						 <tr>
                                 <th>4th Author Name</th>   <td><?php echo $row1['ffat']?></td>
                            </tr>
                         <tr>
						 <tr>
                                 <th>Conference | Journal Name</th>   <td><?php echo $row1['cj_name']?></td>
                            </tr>
                         <tr>
						 <tr>
                                 <th>Paper Type</th>   <td><?php echo $row1['paper_type']?></td>
                            </tr>
                         <tr>
						 <tr>
                                 <th>ISBN |E-ISSN NO</th>   <td><?php echo $row1['isbn']?></td>
                            </tr>
                         <tr>
						 <tr>
                                 <th>DOI Number</th>   <td><?php echo $row1['doi']?></td>
                            </tr>
							<tr>
                                 <th>Volume and Issue</th>   <td><?php echo $row1['v_i']?></td>
                            </tr>
                         <tr>
						 <tr>
                                 <th>Month of Publication</th>   <td><?php echo $row1['mp']?></td>
                            </tr>
                         <tr>
						 <tr>
                                 <th>Year of Publication</th>   <td><?php echo $row1['yp']?></td>
                            </tr>
                         <tr>
                                 <th>Impact Factor</th>   <td><?php echo $row1['impact']?></td>
                            </tr>
                             
                            <tr>
                                 <th> Download Copy</th><td> <?php 
                                         

                                           if($row3['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$rowdid['department']."/".$row3['uname']."/".date('Y')."/Papers/Documents/".$row1['pdf']."' download='".$row1['pdf']."'><i class='fa fa-download'></i></a>";
                                          }
                    ...
                    if($row3['user_type']=='Faculty')
                              {  
                               echo "<iframe src='../Faculty/".$rowdid['department']."/".$row3['uname']."/".date('Y')."/Papers/Documents/".$row1['pdf']."' style=width:90%></iframe>";
                             }
                             elseif($row3['user_type']=='Admin')
                             {
                               echo "<iframe src='../admin/Papers/".date('Y')."/".$row1['pdf']. "' style=width:80%></iframe>";
                             }
                                        // echo "<img height='20%' width='20%' src='Conference/$img[$i]'/>";
                                            } ?>
                            </td></tr>
                            <tr>

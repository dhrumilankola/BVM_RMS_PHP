          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Published Papers Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
                          ...
                          while($row1 = mysqli_fetch_array($result)){
							...
							echo "<td>" . $row1['impact'] . "</td>";
                              ...
                              <td class="project-actions text-left" >
                                ...
                                <a class="btn btn-warning btn-sm" href="apaper.php?paperid=<?php echo $row1['paperid']?>"><i class="fas fa-pencil-alt"></i></a>
			...
			<a href="export_paper.php" class="btn btn-success ">Export CSV</a><br>
          </div>
          </div>
                  <!-- /.card-body -->
        </div>

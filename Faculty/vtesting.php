...
<head>
  ...
  <title>BRMS |Testing | Consultancy  Project</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Testing | Consultancy Projects Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
                      ...
                      <table id="vclient"  class="table table-bordered projects">
                        ...
                        <?php
                          while($row1 = mysqli_fetch_array($result)){                                  
							...
							echo "<td>" . $row1['work_type'] . "</td>";
                             echo "<td>" . $row1['project_name'] . "</td>";
                              echo "<td>" . $sdate . "</td>";
                               echo "<td>" . $edate . "</td>";    
                              echo "<td>" . $row1['role'] . "</td>";
							  echo "<td>" . $row1['agency_name'] . "</td>";
							  echo "<td>" . $row1['amount'] . "</td>";
                              
                              ?>
                              <td class="project-actions text-left">
                                <a class="btn btn-info btn-sm" href="testing.php?tid=<?php echo $row1['tid']?>"><i class="fas fa-eye"></i></a>
                                <a class="btn btn-warning btn-sm" href="atesting.php?tid=<?php echo $row1['tid']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deletetesting.php?tid=<?php echo $row1['tid']?>"><i class="fas fa-trash"></i></a>
                              <!-- </div> -->
                              </td>
			...
			<a href="export_test.php" class="btn btn-success ">Export CSV</a><br>
          </div>
          </div>
                  <!-- /.card-body -->
        </div>

...
<head>
  ...
  <title>BRMS |Edit Conference</title>
                ...
                <div class="row">
                   <div class="col-sm-3">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="2015" id="aydt" value="<?php echo $rows['a_y'] ?>"name="ay"  tabindex="1" required onblur="test()">
                    </div>
                  </div>
				  <div class="col-sm-3">
                    <!-- text input -->
                    <div class="form-group">
					  ...
					  <input type="text" class="form-control" placeholder="2016"  value="<?php echo $rows['e_y'] ?>" name="ey" id="eydt" tabindex="1" required readonly>
                    </div>
                  </div>
					<div class="col-sm-3">
                              <!-- text input -->
			...
			if(elem.value.match(numericExpression)){
				...
				return false;
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $rows['nod'] ?>"placeholder=" 2" tabindex="3" name="nod"  id='nd'required onchange="frmnod()">
                    </div>
                  </div>
				  <div class="col-sm-5">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <textarea class="form-control" placeholder="Pedagogy & Effective use of ICT in Engineering Education & Academic Governance"name="name" tabindex="5" required > <?php echo $rows['name'] ?></textarea>
                        ...
                        window.onload=function() {
                            ...
                            $('#a').change(function () {
                                ...
                                if (data == "Conducted") {
                                    ...
                                    $("#b option[value=Member]").prop('disabled', false);
                  ...
                  <div class="col-sm-2">
                            <div class="form-group">
                                  ...
                                  <select class="form-control"  id="a" tabindex="7" name="as">
                                    <option>Select here </option>
				...
				<div class="col-sm-2">
                            <div class="form-group">
                                  <label>Role</label>
                                  <select class="form-control" id="b"  tabindex="8" name="role">
                                    <option>Select here </option>
                ...
                <div class="form-group">
                  <label>Upload Photos</label>
                   <input type="file" name="photos[]"   tabindex="11 "class="btn btn-info btn-block file" >
                 </div>
               </div>
              </div>

          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <div class="row">
                <div class="col-md-12">
               <?php  
                      $sql = "SELECT * FROM reserch_proj where projectid=".$_GET['projectid'];
                      ...
                      if(mysqli_num_rows($result) > 0){ 
                       ...
                       $timestamp = strtotime($row1['startdate']);
							$sdate = date("d-m-Y",$timestamp );
							
							$timestamp = strtotime($row1['enddate']);
                     ...
                     <table id="vconference"  class="table table-bordered projects">
						 ...
						 <tr>
                              ...
                              <tr>
                                 <th >Start_Date</th><td><?php echo $sdate ?></td>
                            </tr>
                            <tr>
                               <th > End_Date</th><td><?php echo $edate   ?></td>
                            </tr>
							<tr>
                          ...
                          <tr>
                                 <th> Download Copy</th><td> <?php 
                                           ...
                                           if($row3['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$rowdid['department']."/".$row3['uname']."/".date('Y')."/Projects/Documents/".$row1['upload']."' download='".$row1['upload']."'><i class='fa fa-download'></i></a>";
                                          }
                    ...
                    if($row3['user_type']=='Faculty')
                              {  
                               echo "<iframe src='../Faculty/".$rowdid['department']."/". $row3['uname']."/".date('Y')."/Projects/Documents/". $row1['upload'] . "' style=width:80%></iframe>";
                             }

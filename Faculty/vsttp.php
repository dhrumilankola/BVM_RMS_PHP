...
<head>
  ...
  <title>BRMS |View STTP |FDP</title>
...
//                               
                            ...
                            elseif($row2['user_type']=='Admin'){
                              ...
                              <td class="project-actions text-left">
                                <a class="btn btn-info btn-sm" href="sttp.php?sttpid=<?php echo $row1['sttpid']?>"><i class="fas fa-eye"></i></a>
                                <a class="btn btn-warning btn-sm" href="asttp.php?sttpid=<?php echo $row1['sttpid']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deletesttp.php?sttpid=<?php echo $row1['sttpid']?>"><i class="fas fa-trash"></i></a>
                              <!-- </div> -->
                              </td>
		  ...
		  <a href="export_sttp.php" class="btn btn-success ">Export CSV</a><br>
          </div>
                  <!-- /.card-body -->
        </div>
      </div><!--col-->

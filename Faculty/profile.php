                      ...
                      <div class="row">
                        ...
                        <div class="col" style="margin-left: 25px;">
                         ...
                         <div class="row" style="margin-bottom: -10px;margin-left: 25px;" >
                          ...
                          <div class="row" style="margin-bottom: -10px;margin-left: 33.8%;">
                             <div class="form-group" style="color: black">
                         ...
                         <div class="row" style="margin-bottom: -10px;margin-left: 25px;" >
                          <div class="row" style="margin-bottom: -10px;">
                             <div class="form-group" style="color: black">
                              ...
                              <div class="row" style="margin-bottom: -10px;margin-left: 31.6%;">
                             ...
                             <div class="row" style="margin-bottom: -10px;">
                              ...
                              <div class="row" style="margin-bottom: -10px;margin-left: 32.5%;">
                                 <div class="form-group" style="color: black">
								 <?php $timestamp = strtotime($row['bday']);
							$new_date = date("d-m-Y",$timestamp );?>
                                  <label> Birthdate    :</label> <?php echo $new_date; ?>
                                </div>
                              </div>
                            </div>
                             <div class="row" style="margin-bottom: -10px;margin-left: 25px;" >
                             ...
                             <div class="form-group" style="color: black">
                              ...
                              <div class="row" style="margin-bottom: -10px;margin-left:21%;">
                                 <div class="form-group" style="color: black">
...
$row['uname']."/Images/".$row['profile']."'class='img-responsive' width='150' height='180'>";
                    ...
                    <form action="aintsubtask.php?itid=<?php echo $itid?>" method="post" enctype="multipart/form-data">
                      ...
                      if(trim($schlspec) == ''){
							...
							echo '<tr><td style="width:30%"><b>10th</td>';
						 echo '<td style="width:30%">'.$row['schlspec'].
                      ...
                      if(trim($hspec) == ''){
						  ...
						  echo '<tr><td style="width:30%"><b>12th</td>';
                         echo '<td style="width:30%">'.$row['hschool'].
                            '</td><td style="width:30%">'.$row['hspec'].
                            '</td><td style="width:30%">'.$row['hyear'].
                      ...
                      if(trim($dspec) == ''){
							 ...
							 echo '<tr><td style="width:30%"><b>Diploma</td>';
                         echo '<td style="width:30%">'.$row['dspec'].
                      ...
                      {
						  echo '<tr><td style="width:30%"><b>Bachelor Degree</td>';
                           echo '<td style="width:30%">'.$row['degreespec'].
                      ...
                      if(trim($pgspec) == ''){
						  ...
						  echo '<tr><td style="width:30%"><b>Master Degree</td>';
                        echo '<td style="width:30%">'.$row['pgspec'].
                      ...
                      if(trim($otherspec) == ''){
						  ...
						  echo '<tr><td style="width:30%"><b>Phd</td>';
                         echo '<td style="width:30%">'.$row['otherspec'].
                     ...
                     <?php
                        ...
                        if($result1)
                        {
                            if(mysqli_num_rows($result1) > 0)
                            {
                                ...
                                {
									 $timestamp = strtotime($row1['start']);
										 $sdate = date("d-m-Y",$timestamp );
										 
										  $timestamp = strtotime($row1['endate']);

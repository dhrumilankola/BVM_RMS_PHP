...
if(isset($_POST['Export'])){
 ...
 $result = mysqli_query($link,
			...
			aid='$session_aid' AND a_y ='$fromdate.date(Y)' AND e_y ='$todate.date(Y)'
			UNION ALL 
...
elseif($user_work == 'Seminars'){
    ...
    $result=mysqli_query($link,"SELECT * from seminars where aid='$session_aid' 
        ...
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
				...
				<?php   $sql1="select * from user where aid='$session_aid'";
...
=======
>>>>>>> e80338b21a265cd365441a72d1f75f3f8e70078a
					</div>
                </div>
                       ...
                       <label>Select Work</label>
                           <select name="user_work" id="user_work" class="form-control" >
                              ...
                              <option value="Seminars">Seminars</option>
							   ...
							   <option value="STTP_FDP">STTP_FDP</option>
			...
			<div class="col-md-12" id= "showwork">
					  ...
					  as documents from book b where aid='$session_aid' 
					  ...
					  from conference con where aid='$session_aid' 
			...
			as ay,pap.e_y as ey, pap.typeofwork as typeofwork,pap.pdf as documents from papers
					  ...
					  from reserch_proj res where aid='$session_aid'

					  UNION ALL 
					  SELECT sem.semid as id ,sem.name as name,sem.a_y 
						as ay,sem.e_y as ey,sem.typeofwork as typeofwork,
						sem.photos as documents 					  
					  from seminars sem where aid='$session_aid'
			...
			aid='$session_aid'  ";
                  ...
                  <div class="col-sm-1.2">
                    <div class="col-sm-12">
                    <input type="submit" class="btn btn-info" name="Export" value="Export" target="_blank">
                      <!--<input type="submit" class="btn btn-success" name="Export CSV" value="CSV"> -->    
                  </div>
                  </div>

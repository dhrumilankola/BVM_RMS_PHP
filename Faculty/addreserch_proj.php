...
//             }
        ...
        $desired_dir=$rowdid['department']."/". $row['uname']."/".date('Y').'/Projects/Documents/';
        if(empty($errors)==true){
            if(is_dir($desired_dir)==false){
                mkdir("$desired_dir", 0700);    // Create directory if it does not exist
            }
            if(is_dir("$desired_dir/".$file_name)==false){
                move_uploaded_file($file_tmp,$rowdid['department']."/". $row['uname']."/".date('Y').'/Projects/Documents/'.$file_name);
            }else{                  //rename the file if another one exist
                $new_dir=$rowdid['department']."/". $row['uname']."/".date('Y').'/Projects/Documents/'.$file_name.time();
  ...
  if(empty($error)){
     $upload = implode("|", $imageData);
      $query="INSERT INTO reserch_proj (a_y,e_y,project_name,startdate,enddate,role,
	  aid, agency_name,amount,sanction_letter_no ,decr,upload)
VALUES ('$ay','$ey','$pname','$sdate','$edate','$role','$session_aid',
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="addreserch_proj.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Details</p>
                  </a>
                </li>
        ...
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Add Research Project Projects</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
		...
		function maderole(elem, helperMsg){
			if(elem.value == "Select here"){
				...
				<div class="col-sm-2">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  tabindex="3" placeholder="Enter ..." name="pname" required >
                    </div>
                  </div>
                   ...
                   <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control"  tabindex="4"  placeholder="Enter ..." name="sdate" required>
                    </div>
                </div>
                 <div class="col-sm-2">
                    <div class="form-group">
                      <label>End Date</label>
                      <input type="date" class="form-control"  tabindex="5"  placeholder="Enter ..." name="edate" required>
                    </div>
                </div>
				<div class="col-sm-3">
                            <div class="form-group">
                                  <label>Role</label>
                                  <select class="form-control"   tabindex="6" name="role" id='role' required>
				  ...
				  <div class="col-sm-4">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control"   tabindex="7" placeholder="DST  " name="an" required>
				  ...
				  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                <label>Amount</label>
                                <input type="text" class="form-control"   tabindex="8" placeholder="1,00,000 " name="amount" required>
                                <!-- data-date-format="DD MMMM YYYY" -->
                              </div>
                  </div>
				  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control"   tabindex="9" placeholder="DST-Gujcost-12112019 " name="sln" required>
                                <!-- data-date-format="DD MMMM YYYY" -->
                              </div>
                  </div>
				  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                     ...
                     <textarea class="form-control"  tabindex="10" placeholder="Enter ..."name="decr" required></textarea>
                    </div>
                  </div>
                  <div class="col-sm-3">
                <div class="form-group">
                    <label>Upload Project Report</label>
                   <input type="file" name="upload[]"  tabindex="11"  class="btn btn-info btn-block file" required>
                 </div>
               </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                      <div class="col-sm-12">
                    <input type="submit" class="btn btn-success"  tabindex="12" name="addproject" value="Submit">     

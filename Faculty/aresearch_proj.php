...
<head>
  ...
  <title>BRMS |View Research  Project</title>
              ...
              <div class="card-body">
				...
				<div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $ay;?>" placeholder="2015" name="ay" id="aydt"  tabindex="1" required onblur="test()">
                    </div>
                  </div>
				  <div class="col-sm-2">
                    <!-- text input -->

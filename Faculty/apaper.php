              ...
              <div class="card-body">
				...
				<div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $ay; ?>"placeholder="2015" id="aydt"  name="ay"  tabindex="1" required onblur="test()">
                    </div>
                  </div>
				  <div class="col-sm-2">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $ey; ?>"placeholder="2016" name="ey" id="eydt"  tabindex="2" required readonly>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <!-- text input -->

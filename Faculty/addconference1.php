        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="addconference.php" class="nav-link active">
        ...
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Add Conference Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <div class="row">
                   <div class="col-sm-2">
					...
					<script>						
						function test(){
							...
							let endYear = value + 1;
							document.getElementById('eydt').value = endYear;
							
							document.getElementById("sdate").min = startYear + "-07-01";
							document.getElementById("sdate").max = endYear + "-06-30";
							document.getElementById("edate").min = startYear + "-07-01";
							document.getElementById("edate").max = endYear + "-06-30";
						}
						...
						function checkDate(){
							...
							if(syear != startDate.getFullYear()){
								alert("Kindly Check Start or End Academic Year!");
							}else if(eyear != endDate.getFullYear()){
								//alert("your message dgp");
							}
						}
				  ...
				  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                ...
                                <input type="date" id="sdate" min="2022-07-1" max="2023-06-30"  class="form-control" name="sdate"  tabindex="2" required pattern="\Y{4}-\m{2}-\d{2}">
				  ...
				  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                ...
                                <input type="date" id="edate"  class="form-control" name="edate"  tabindex="2" required pattern="\Y{4}-\m{2}-\d{2}" onblur="daysDifference();checkDate()">
                                <!-- data-date-format="DD MMMM YYYY" -->
                              </div>
                  </div>
				  <div class="col-sm-2">
...
<!-- Moment js for date cahnge purpose -->

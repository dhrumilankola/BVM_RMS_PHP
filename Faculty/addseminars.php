...
if (isset($_POST['addseminar'])) {
  ...
  if (isset($_FILES['photos'])) {
    ...
    if (empty($error)) {
      ...
      $query = "INSERT INTO seminars (a_y,e_y,date,total_hours,
	 name,decr,type,role,audience,cu_name,dp_name,aid, photos)
	VALUES ('$ay','$ey','$date','$th','$name','$decr','$type',
	'$mode','$audi','$cuname','$dpname','$session_aid','$photos')";
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="addseminars.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Details</p>
                  </a>
                </li>
            ...
            <div class="col-md-12">
              ...
              <div class="card card-secondary">
                <div class="card-header">
                  <h3 class="card-title">Add Seminar/Symposium /Webinar Details</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    function frmselect() {
                      ...
                      if (madetype(type, "Please Select Type of Work")) {
                        if (madeas(mode, "Please Select Type of Mode ")) {
                          if (maderole(audi, "Please Select Type of Audience ")) {
                            return true;
                          }
                        }
                      }
                  ...
                  <form action="#" method="post" enctype="multipart/form-data" onsubmit=" return frmselect()">
                    <div class="row">
                      <div class="col-sm-2">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="aydt" placeholder="2015" name="ay" tabindex="1" onblur="test()" required>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <!-- text input -->
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="eydt" placeholder="2016" name="ey" tabindex="1" required readonly>
                        </div>
                      </div>
                      <script type='text/javascript'>
                        function frmnod() {
                      ...
                      <div class="col-sm-3">
                        ...
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="sdate" id="sdate" onblur="updateEndDate()" tabindex="2" required pattern="\Y{4}-\m{2}-\d{2}">
                      ...
                      <div class="col-sm-3">
                        ...
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="edate" id="edate" onblur="daysDifference()" tabindex="2" required pattern="\Y{4}-\m{2}-\d{2}">
                          <!-- data-date-format="DD MMMM YYYY" -->
                        </div>
                      </div>
                      <div class="col-sm-2">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="" placeholder="enter hours" name="th" tabindex="3" required>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <!-- text input -->
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          <label>Role</label>
                          <select class="form-control" name="role" id='mode' tabindex="7" required>
                            <option>Select here </option>
                            <option value="Organizer">Organizer</option>
                            <option value="Participant">Participant</option>
                            <option value="Speaker">Speaker</option>
                            <option value="Speaker">Team Member</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="audi" id='audi' tabindex="8" required>
                            <option>Select here </option>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12">
                        <div class="col-sm-12">
                          <input type="submit" class="btn btn-success" name="addseminar" tabindex="13" value="Submit">
  ...
  <footer class="main-footer">
    <strong>Design & Developed By &copy;
      <!-- 2014-2019 --> <a href="#">Prof.Dharmesh Patel</a>.
    </strong>
    BVM IT Department.

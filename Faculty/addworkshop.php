...
//             }
  ...
  if(empty($error)){
    ...
    $photos = implode("|", $imageData);
     $query="INSERT INTO workshop(a_y,e_y,sdate,edate,nod,
	 name,decr,mode,role,user,cu_name,dp_name,aid, photos)
	VALUES ('$ay','$ey','$sdate','$edate','$nod','$name','$decr','$mode',
	'$role','$user','$cuname','$dpname','$session_aid','$photos')";
 if(mysqli_query($link,$query)){
  echo "<script>alert('Workshop Detail Added Successfully')</script>";
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="addworkshop.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Details</p>
                </a>
              </li>
        ...
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Add Workshop Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <div class="row">
				  ...
				  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                ...
                                <input type="date"  class="form-control" name="sdate"  tabindex="3" required pattern="\Y{4}-\m{2}-\d{2}">
				  ...
				  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                ...
                                <input type="date"  class="form-control" name="edate"  tabindex="4" required pattern="\Y{4}-\m{2}-\d{2}">
                                <!-- data-date-format="DD MMMM YYYY" -->
                              </div>
                  </div>
				  <div class="col-sm-2">

...
//             }        
        ...
        $desired_dir=$rowdid['department']."/". $row['uname']."/".date('Y').'/IndustryVisit/Photos/';
        if(empty($errors)==true){
            if(is_dir($desired_dir)==false){
                mkdir("$desired_dir", 0700);    // Create directory if it does not exist
            }
            if(is_dir("$desired_dir/".$file_name)==false){
                move_uploaded_file($file_tmp,$rowdid['department']."/". $row['uname']."/".date('Y').'/IndustryVisit/Photos/'.$file_name);
            }else{                  //rename the file if another one exist
                $new_dir=$rowdid['department']."/". $row['uname']."/".date('Y').'/IndustryVisit/Photos/'.$file_name.time();
  ...
  if(empty($error)){
     ...
     $query="INSERT INTO ind_visit (a_y ,e_y,industry_name,ind_city,ind_state, sem,date ,decr,photos , aid ,noofstud)VALUES ('$ay','$ey','$industry_name','$ind_city','$ind_state','$zip','$date','$decr','$photos','$session_aid','$noofstud')";
       if(mysqli_query($link,$query)){
        echo "<script>alert('Industrial Visit Details Added Successfully')</script>";
...
<head>
  ...
  <title>BRMS | Industrial Visit</title>
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="addind_visit.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Details</p>
                  </a>
                </li>
        ...
        <div class="row mb-2">
          ...
          <!-- <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Industrial Visit Details</li>
            </ol>
          </div> -->
          <!-- /.col -->
        </div>
				...
				<div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="2016" name="ey" id="eydt" tabindex="2" required readonly>
                              ...
                              <div class="form-group">
                                ...
                                <input type="date"  class="form-control"  tabindex="3" name="date" required pattern="\Y{4}-\m{2}-\d{2}" >
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" tabindex="4"  placeholder="Enter ..." name="industry_name" required >
                    </div>
                  </div>
                   <div class="col-sm-6">
                      ...
                      <div class="form-group">
                       ...
                       <textarea class="form-control"  tabindex="5" placeholder="Enter ..."name="decr" required></textarea>
                 ...
                 <div class="col-sm-3">
                          <div class="form-group">
                                        <label>City</label>
                                        <input type="text" class="form-control" tabindex="6"  placeholder="V V Nagar" name="ind_city" required>
                   ...
                   <div class="col-sm-3">
                          <div class="form-group">
                                        <label>State</label>
                                        <input type="text" class="form-control"  tabindex="7" placeholder="Gujarat" name="ind_state" required>
			...
			if(elem.value.match(numericExpression)){
				...
				return false;
                   ...
                   <div class="col-sm-3">
                          <div class="form-group">
                                        <label>Sem No</label>
                                        <input type="text" class="form-control"  tabindex="8" placeholder="6" id='zip' name="zip" required onchange='return formZip()'>
			...
			if(elem.value.match(numericExpression)){
				...
				return false;
                  ...
                  <div class="col-sm-3">
                      ...
                      <input type="text" class="form-control"  tabindex="9" placeholder="50" name="noofstud"  id='nd'required onchange="frmnod()">
                ...
                <div class="form-group">
                  <label>Upload Photos</label>
                   <input type="file" name="photos[]"  tabindex="10" class="btn btn-info btn-block file" required>
                 </div>
               </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                  <div class="col-sm-12">
                  <input type="submit" class="btn btn-success"  tabindex="11" name="addind_visit" value="Submit">
                   <button type="reset" class="btn btn-danger float-right"  tabindex="12"><i class="glyphicon glyphicon-repeat"></i>Reset</button>               
                  </div>
                  </div>
                </div>
                <!-- /.row -->

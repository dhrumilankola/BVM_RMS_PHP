...
<head>
  ...
  <title>BRMS |View Workshop</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Workshop  Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM workshop where aid='$session_aid'";
                      ...
                      <table id="vclient"  class="table table-bordered projects">
                        ...
                        <?php
                          while($row1 = mysqli_fetch_array($result)){
                            ?>
                            <tr><?php
							$timestamp = strtotime($row1['sdate']);
							$sdate = date("d-m-Y",$timestamp );
							$timestamp = strtotime($row1['edate']);
...
//                               
                            ...
                            elseif($row2['user_type']=='Admin'){
                              ...
                              <td class="project-actions text-left">
                                <a class="btn btn-info btn-sm" href="workshop.php?workshopid=<?php echo $row1['workshopid']?>"><i class="fas fa-eye"></i></a>
                                <a class="btn btn-warning btn-sm" href="aworkshop.php?workshopid=<?php echo $row1['workshopid']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deleteworkshop.php?workshopid=<?php echo $row1['workshopid']?>"><i class="fas fa-trash"></i></a>
                              <!-- </div> -->
                              </td>
			...
			<a href="export_work.php" class="btn btn-success ">Export CSV</a><br>
          </div>
          </div>
                  <!-- /.card-body -->
        </div>

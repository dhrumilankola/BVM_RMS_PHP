          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Patents Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
                          ...
                          while($row1 = mysqli_fetch_array($result)){
                            ...
                            // echo "<td>" . $row1['conid'] . "</td>";
							  ...
							  echo "<td>" . $row1['a_y'].'-' .$row1['e_y'] . "</td>";
							   echo "<td>" . $new_date . "</td>";							  
                             echo "<td>" . $row1['patent_no'] . "</td>";                              
                               echo "<td>" . $row1['name'] . "</td>";
							   echo "<td>" . $row1['agent'] . "</td>";
...
//                                echo "<td>". count(explode("|",$row1['photos']))."</td>";
                              ...
                              {
                               //echo "<td><img style=width:100px;height:80px; src='../Faculty/".$rowdid['department']."/". $row2['uname']."/".date('Y')."/Patent/Documents/". $row1['docc'] . "'/></td>";
								/* echo "<td style=width:15%><iframe src='../Faculty/".$rowdid['department']."/". $row2['uname']."/".date('Y')."/Patent/Documents/". $row1['docc']."' style=width:100%></iframe></td>"; */
							}
                            elseif($row2['user_type']=='Admin'){
                              ...
                              <td class="project-actions text-left">
                                <a class="btn btn-info btn-sm" href="patent.php?pid=<?php echo $row1['pid']?>"><i class="fas fa-eye"></i></a>
                                <a class="btn btn-warning btn-sm" href="apatent.php?pid=<?php echo $row1['pid']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deletepatent.php?pid=<?php echo $row1['pid']?>"><i class="fas fa-trash"></i></a>
                              <!-- </div> -->
                              </td>
			...
			<a href="export_pat.php" class="btn btn-success ">Export CSV</a><br>
          </div>
          </div>
                  <!-- /.card-body -->
        </div>

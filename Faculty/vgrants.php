...
<head>
  ...
  <title>BRMS |View Grant Details</title>
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="vgrants.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Details</p>
                </a>
              </li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Grant Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
               ...
               <?php  
                      ...
                      if(mysqli_num_rows($result) > 0){ 
                       ...
                       ?>
                      <table id="vclient"  class="table table-bordered projects">
                        <thead>
                              <tr>
                              <th>Sy - Ey</th>
                        ...
                        <?php
                          while($row1 = mysqli_fetch_array($result)){
                            ...
                            // $sqldid=mysqli_query($link,"select * from Department WHERE did IN (select did from user where aid=$row2[aid])");
							  ...
							  echo "<td>" . $row1['sy'].'-' .$row1['ey'] . "</td>";
							   echo "<td>" . $row1['sr_no'] . "</td>";
							  echo "<td>" . $row1['Name_of_the_Principal_Investigator_Co_Investigator'] . "</td>";
							  echo "<td>" . $row1['department_of_investigator'] . "</td>";
							  echo "<td>" . $row1['Name_of_the_Funding_agency'] . "</td>";                             							
                echo "<td>" . $row1['G_Type'] . "</td>";
							   echo "<td>" . $row1['Department_of_Principal_Investigator_Co_Investigator'] . "</td>";
                 echo "<td>" . $row1['Year_of_Award'] . "</td>";
                 echo "<td>" . $row1['Funds_provided'] . "</td>";
                 echo "<td>" . $row1['Duration_of_the_project'] . "</td>";
                            
                              ?>
                              <td class="project-actions text-left" >
                                  <a class="btn btn-info btn-sm" href="grants.php?id=<?php echo $row1['id']?>"><i class="fas fa-eye"></i></a>
                                <a class="btn btn-warning btn-sm" href="agrants.php?id=<?php echo $row1['id']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deletegrants.php?id=<?php echo $row1['id']?>"><i class="fas fa-trash"></i></a>
                               </div> 
                              </td>
			...
			<a href="export_grants.php" class="btn btn-success ">Export CSV</a><br>
          </div>
          </div>
                  <!-- /.card-body -->
        </div>

...
<head>
  ...
  <title>Technoguide | Visa Consultancy</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Visa Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM addvisa";
                      if($result = mysqli_query($link, $sql)){
                      if(mysqli_num_rows($result) > 0){ 

                       ?>
                      <table id="view_visa"  class="table table-bordered projects">
                        <thead>
                              <tr>
                              <th> ID</th>
                               <th > Photo</th>
                        ...
                        <?php
                          while($row = mysqli_fetch_array($result)){
                            ?>
                            <tr><?php
                            echo "<td>" . $row['visa_id'] . "</td>";
                             echo "<td><img style=width:100px;height:80px; src='images/" . $row['photo'] . "'/></td>";
                             echo "<td class=col-md-1>" . $row['visa_date'] . "</td>";
                              echo "<td>" . $row['name'] . "</td>";
                               echo "<td>" . $row['mno'] . "</td>";
                              ...
                              echo "<td class=col-md-0>" . $row['gender'] . "</td>";
                              ...
                              <td class="project-actions text-left">
                               ...
                               <!--  <a class="btn btn-info btn-sm" href="#"><i class="fas fa-share-alt"></i></a> -->
                                ...
                                <a class="btn btn-info btn-sm" href="avisa.php?visa_id=<?php echo $row['visa_id']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deletevisa.php?visa_id=<?php echo $row['visa_id']?>"><i class="fas fa-trash"></i></a>
                              <!-- </div> -->
                              </td>

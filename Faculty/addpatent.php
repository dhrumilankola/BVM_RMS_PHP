...
//             }
        ...
        $desired_dir=$rowdid['department']."/". $row['uname']."/".date('Y').'/Patent/Documents/';
        if(empty($errors)==true){
            if(is_dir($desired_dir)==false){
                mkdir("$desired_dir", 0700);    // Create directory if it does not exist
            }
            if(is_dir("$desired_dir/".$file_name)==false){
                move_uploaded_file($file_tmp,$rowdid['department']."/". $row['uname']."/".date('Y').'/Patent/Documents/'.$file_name);
            }else{                  //rename the file if another one exist
                $new_dir=$rowdid['department']."/". $row['uname']."/".date('Y').'/Patent/Documents/'.$file_name.time();
  ...
  if(empty($error)){
     ...
     $query="INSERT INTO patent (a_y,e_y,name,date,patent_no,
	 agent,decr,aid, docc)
	VALUES ('$ay','$ey','$name','$date','$pn','$agent','$decr',
	'$session_aid','$pdfs')";
 if(mysqli_query($link,$query)){
  echo "<script>alert('Patent Detail Added Successfully')</script>";
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="addconference.php" class="nav-line">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="addpatent.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Details</p>
                  </a>
                </li>
        ...
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Add Patent Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <div class="row">
				  ...
				  <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="2016" name="ey" id="eydt" tabindex="1" required readonly>
                    </div>
                  </div>
				  <div class="col-sm-3">
                              <!-- text input -->
                              <div class="form-group">
                                ...
                                <input type="date"  class="form-control" name="date"  tabindex="2" required pattern="\Y{4}-\m{2}-\d{2}">
				  ...
				  <div class="col-sm-5">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Indic-123_pdg-1234" name="pn"  tabindex="1" required>
                    </div>
                  </div>
				   <div class="col-sm-6">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Pedagogy & Effective use of ICT in Engineering Education & Academic Governance" name="title"  tabindex="4" required>
                    </div>
                  </div>
				  ...
				  <div class="col-sm-6">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control"   tabindex="9" placeholder="Birla Vishvakarma Mahavidyalaya " name="agent">
                ...
                <div class="form-group">
                  <label>Upload Doc</label>
                   <input type="file" name="pdfs[]" class="btn btn-info btn-block file"  tabindex="11" required>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="col-sm-12">
                    <input type="submit" class="btn btn-info" name="addpatent"  tabindex="13" value="submit">
                  <button type="reset" class="btn btn-secondary float-right"  tabindex="14"><i class="glyphicon glyphicon-repeat"></i>Reset</button>       
				  </div>
                  </div>
                </div>
                <!-- /.row -->

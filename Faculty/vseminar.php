...
//                                echo "<td>". count(explode("|",$row1['photos']))."</td>";
                            ...
                            elseif($row2['user_type']=='Admin'){
                              ...
                              <td class="project-actions text-left">
                                ...
                                <a class="btn btn-warning btn-sm" href="aseminar.php?semid=<?php echo $row1['semid']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deleteseminar.php?semid=<?php echo $row1['semid']?>"><i class="fas fa-trash"></i></a>
                              <!-- </div> -->
                              </td>
		  ...
		  <a href="export_sem.php" class="btn btn-success ">Export CSV</a><br>
          </div>
                  <!-- /.card-body -->
        </div>
      </div><!--col-->

...
<!--                    Display Data -->                    
                      ...
                      <table id="vconference"  class="table table-bordered projects">
                          ...
                          <tr>
                             ...
                             <tr>
                                  <th >User</th><td><?php echo $row2['uname']  ?></td>
                            </tr>
                             <tr>
                                  <th >Semester</th><td><?php echo $row1['sem']  ?></td>
                            </tr>
                             <tr>
                                 <th > Total Students</th><td><?php echo $row1['noofstud'] ?></td>
                            </tr>
                            <tr>
...
//                                        
                                        echo "<img height='20%' width='80%' src='".$rowdid['department']."/". $row['uname']."/".date('Y')."/IndustryVisit/Photos/$img[$i]'/>";
                                            } ?>
                            </td></tr>
                            <tr>

          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Published Book Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
               ...
               <?php  
                     ...
                     <table id="vconference"  class="table table-bordered projects">
                         <tr>
                              ...
                              <tr>
                                  <th> Book Title</th><td><?php echo $row1['book_title'] ?></td>
                            </tr>
                            <tr>
                                <th >No of Author</th><td><?php echo $row1['no_at']  ?></td>
                            </tr>
							<tr>
                                <th >First Author Name</th><td><?php echo $row1['fat']  ?></td>
                            </tr>
							<tr>
                                <th >Second Author Name</th><td><?php echo $row1['sat']  ?></td>
                            </tr>
							<tr>
                                <th >Third Author Name</th><td><?php echo $row1['tat']  ?></td>
                            </tr>
                             <tr>
                                 <th >Book Field</th><td><?php echo $row1['area'] ?></td>
                            </tr>
                          <tr>
                                <th >Book Edition</th><td><?php echo $row1['book_edi'] ?></td>
                            </tr>
							 <tr>
                                <th >ISBN | ISSN NO</th><td><?php echo $row1['isbn'] ?></td>
                            </tr>
							 <tr>
                                <th >Book Price</th><td><?php echo $row1['bp'] ?></td>
                            </tr>
							 <tr>
                                <th >Year of Publication</th><td><?php echo $row1['yp'] ?></td>
                            </tr>
                           <tr>
                                <th >Publisher Name</th><td><?php echo $row1['pn'] ?></td>
                            </tr>
							<tr>
                                <th >Publisher Website</th><td><?php echo $row1['pw'] ?></td>
                            </tr>
							<tr>
                                 <th> Download Copy</th><td> <?php 
                                           ...
                                           if($row3['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$rowdid['department']."/".$row3['uname']."/".date('Y')."/Books/Documents/".$row1['docc']."' download='".$row1['docc']."'><i class='fa fa-download'></i></a>";
                                          }
                               ...
                               $sqldid=mysqli_query($link,"SELECT * from Department WHERE did IN (select did from user where aid=$row3[aid])");
                                  $rowdid=mysqli_fetch_array($sqldid);
                                    for($i = 0; $i < count($img); $i++){
 										...
 										if($row3['user_type']=='Faculty')
                              {    
                                echo "<iframe src='../Faculty/".$rowdid['department']."/". $row3['uname']."/".date('Y')."/Books/Documents/". $row1['docc']."' style=width:40%></iframe>";
                              }
                              elseif($row3['user_type']=='Admin')
                              {
                                 echo "<iframe src='../admin/Books/".date('Y')."/". $row1['docc']. "' style=width:20%></iframe>";
                              }

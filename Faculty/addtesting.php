...
if(isset($_FILES['upload'])){
  ...
  foreach($_FILES['upload']['tmp_name'] as $key => $tmp_name ){
    $file_name = $key.$_FILES['upload']['name'][$key];
    $file_tmp =$_FILES['upload']['tmp_name'][$key];
//             if($file_size > 2097152){
//                 $errors[]='File size must be less than 2 MB';
//             }
        array_push($imageData, $file_name);
        $desired_dir=$rowdid['department']."/". $row['uname']."/".date('Y').'/Testing_Consultancy/Documents/';
        if(empty($errors)==true){
            if(is_dir($desired_dir)==false){
                mkdir("$desired_dir", 0700);    // Create directory if it does not exist
            }
            if(is_dir("$desired_dir/".$file_name)==false){
                move_uploaded_file($file_tmp,$rowdid['department']."/". $row['uname']."/".date('Y').'/Testing_Consultancy/Documents/'.$file_name);
            }else{                  //rename the file if another one exist
                $new_dir=$rowdid['department']."/". $row['uname']."/".date('Y').'/Testing_Consultancy/Documents/'.$file_name.time();
  ...
  if(empty($error)){
     $upload = implode("|", $imageData);
      $query="INSERT INTO testing (a_y,e_y,work_type,project_name,startdate,enddate,role,
	  aid, agency_name,amount,sanction_letter_no ,decr,upload)
VALUES ('$ay','$ey','$wt','$pname','$sdate','$edate','$role','$session_aid',
'$an','$amount','$sln','$decr','$upload')";
if(mysqli_query($link,$query)){
  echo "<script>alert('Testing | Consultancy Project Added Successfully')</script>";
...
<head>
  ...
  <title>BRMS |Add Testing | Consultancy Project Works</title>
	...
	<!-- Sidebar user panel (optional) -->
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              <a href="enqiryvew.php" class="nav-link active">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="addtesting.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Details</p>
                  </a>
                </li>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Add Testing | Consultancy Projects Works Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
		...
		function frmselect(){				
			...
			if(maderole(role, "Please Select Role Type  ")){
			if(madewt(wt, "Please Select Work Type  ")){
									return true;
		...
		function madewt(elem, helperMsg){
			if(elem.value == "Select here"){
				alert(helperMsg);
				elem.focus();
				return false;
				...
				<div class="col-sm-2">
				  ...
				  <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="2016"  id="eydt" name="ey"  tabindex="2" required readonly>
                    </div>
                  </div>
				  <div class="col-sm-2">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <select class="form-control"   tabindex="3" name="wt" id='wt'>
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" tabindex="4" placeholder="Enter ..." name="pname" required >
                    </div>
                  </div>
                   ...
                   <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control"  tabindex="5" placeholder="Enter ..." name="sdate" required>
                    </div>
                </div>
                 <div class="col-sm-2">
                    <div class="form-group">
                      <label>End Date</label>
                      <input type="date" class="form-control" tabindex="6" placeholder="Enter ..." name="edate" required>
                    </div>
                </div>
				<div class="col-sm-3">
                            <div class="form-group">
                                  <label>Role</label>
                                  <select class="form-control"   tabindex="7" name="role" id='role' required>
                                    <option>Select here </option>
				  ...
				  <div class="col-sm-5">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control"   tabindex="8" placeholder="DST  " name="an" required>
				  ...
				  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                <label>Amount</label>
                                <input type="text" class="form-control"   tabindex="9" placeholder="1,00,000 " name="amount" required>
                                <!-- data-date-format="DD MMMM YYYY" -->
                              </div>
                  </div>
				  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control"   tabindex="10" placeholder="DST-Gujcost-12112019 " name="sln" required>
                                <!-- data-date-format="DD MMMM YYYY" -->
                              </div>
                  </div>
				  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                     ...
                     <textarea class="form-control"  tabindex="11"placeholder="Enter ..."name="decr" required></textarea>
                    </div>
                  </div> 
                  <div class="col-sm-3">
                <div class="form-group">
                    <label>Upload Project Report</label>
                   <input type="file" name="upload[]"  tabindex="12" class="btn btn-info btn-block file" required>
                 </div>
               </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                      <div class="col-sm-12">
                    <input type="submit" class="btn btn-success"  tabindex="13"name="addproject" value="Submit">     

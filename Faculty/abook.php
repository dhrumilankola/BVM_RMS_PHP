...
if(isset($_POST['updatebook'])){
 ...
 $file_type=$_FILES['pdfs']['type'][$key];
    ...
    {
   $desired_dir= '../Faculty/'.$rowdid['department']."/".$row3['uname']."/".date('Y').'/Books/Documents';
 }
 ...
 {
     $sql= "UPDATE book SET a_y='$ay',e_y='$ey',book_title='$bt',no_at='$not',
	 fat='$fat',sat='$sat',tat='$tat',area='$ba',book_edi='$be',isbn='$isbn'
	 ,bp='$bp',yp='$yp',pn='$pn',pw='$pw',docc='$pdfs' WHERE bookid='$bookid'";
...
<head>
  ...
  <title>BRMS |Edit  Book Details</title>
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
				...
				<div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $rows['a_y'];?>" placeholder="2015" name="ay" id="aydt" tabindex="1" required onblur="test()">
                    </div>
                  </div>
				  <div class="col-sm-2">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $rows['e_y'];?>" placeholder="2016" name="ey" id="eydt" tabindex="1" required readonly>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  value="<?php echo $rows['book_title'];?>" placeholder="CRYPTOGRAPHY AND NETWORK SECURITY PRINCIPLES AND PRACTICE" name="bt" required>
                    </div>
                  </div>            
                 <div class="col-sm-2">
                            <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  value="<?php echo $rows['fat'];?>" placeholder="Dr.Indrajit N.Patel " name="fat" required >
                    </div>					
                </div>
				<div class="col-sm-4">
                    <div class="form-group">
                      <label>2nd Author Name</label>
                      <input type="text" class="form-control"value="<?php echo $rows['sat'];?>" placeholder="Dr.Keyur Nayankumar Brahmbhatt" name="sat">
                    </div>					
                </div>
				<div class="col-sm-4">
                    <div class="form-group">
                      <label>3rd Author Name</label>
                      <input type="text" class="form-control"value="<?php echo $rows['tat'];?>" placeholder="Dr.J.M.Rathod" name="tat">
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>Book Field</label>
                      <input type="text" class="form-control" value="<?php echo $rows['area'];?>" placeholder="Information Security" name="ba" required >
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>Book Edition</label>
                      <input type="text" class="form-control" value="<?php echo $rows['book_edi'];?>" placeholder="Fiffth" name="be" required >
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>ISBN | ISSN NO</label>
                      <input type="text" class="form-control" value="<?php echo $rows['isbn'];?>" placeholder="ISBN 13: 978-0-13-609704-4" name="isbn" required >
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>Book Price</label>
                      <input type="text" class="form-control" value="<?php echo $rows['bp'];?>" placeholder="450 Rs" name="bp" required  pattern="[0-9]+">
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>Year of Publication</label>
                      <input type="text" class="form-control" value="<?php echo $rows['yp'];?>" placeholder="2019" name="yp" required pattern="[0-9]+" >
                    </div>					
                </div>
				<div class="col-sm-4">
                    <div class="form-group">
                      <label>Publisher Name</label>
                      <input type="text" class="form-control" value="<?php echo $rows['pn'];?>"  placeholder="Pearson Education, Inc.," name="pn" required >
                    </div>					
                </div>
				<div class="col-sm-5">
                    <div class="form-group">
                      <label>Publisher Website</label>
                      <input type="text" class="form-control" value="<?php echo $rows['pw'];?>" placeholder="https://www.pearson.com/" name="pw" required >
                    </div>					
                </div>
              ...
              <div class="col-sm-3">
                <div class="form-group">
                   <input type="file" name="pdfs[]" class="btn btn-info btn-block file" >
                 </div>
               </div>
                <div class="row">
                  <div class="col-sm-12">

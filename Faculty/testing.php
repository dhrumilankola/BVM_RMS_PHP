...
<head>
  ...
  <title>BRMS |View Testing | Consultancy  Project Details</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Research Project Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
                <div class="col-md-12">
               <?php  
                      $sql = "SELECT * FROM testing where tid=".$_GET['tid'];
                     ...
                     <table id="vconference"  class="table table-bordered projects">
                         <tr>
                                 <th > Academic_Year</th><td><?php echo $row1['a_y'] ?></td>
                            </tr>
							<tr>
                                 <th >Work Type</th><td><?php echo $row1['work_type'] ?></td>
                            </tr>
						 <tr>
                                 <th >Project_Name</th><td><?php echo $row1['project_name'] ?></td>
                            </tr>
                         
                              <tr>
                                 <th >Start_Date</th><td><?php echo $row1['startdate'] ?></td>
                            </tr>
                            <tr>
                               <th > End_Date</th><td><?php echo $row1['enddate']    ?></td>
                            </tr>
							<tr>
                               <th > Role</th><td><?php echo $row1['role']    ?></td>
                            </tr>
							<tr>
                               <th > Agency_Name</th><td><?php echo $row1['agency_name']    ?></td>
                            </tr>
							<tr>
                               <th >Amount</th><td><?php echo $row1['amount']    ?></td>
                            </tr>
                             <tr>
                          ...
                          <tr>
                                 <th> Download Copy</th><td> <?php 
                                           ...
                                           if($row3['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$rowdid['department']."/".$row3['uname']."/".date('Y')."/Testing_Consultancy/Documents/".$row1['upload']."' download='".$row1['upload']."'><i class='fa fa-download'></i></a>";
                                          }
                           ...
                           <tr col-span="2">
                               <th>Reports  </th>
                               <td><?php $img=explode("|",$row1['upload']);
                    ...
                    if($row3['user_type']=='Faculty')
                              {  
                               echo "<iframe src='../Faculty/".$rowdid['department']."/". $row3['uname']."/".date('Y')."/Testing_Consultancy/Documents/". $row1['upload'] . "' style=width:50%></iframe>";
                             }
                             elseif($row3['user_type']=='Admin')
                             {
                               echo "<iframe src='../admin/Papers/".date('Y')."/". $row1['upload']. "' style=width:20%></iframe>";
                             }

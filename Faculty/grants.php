          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Grants Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM grant_detils where id=".$_GET['id'];
                     ...
                     <table id="vconference"  class="table table-bordered projects">
                         <tr>
                                  <th >sy-ey</th>  <td><?php echo $row1['sy'].'-' .$row1['ey'] ?></td>
                            </tr>
                              <tr>
                                  <th>sr no</th><td><?php echo $row1['sr_no'] ?></td>
                            </tr>
                            <tr>
                                <th >Principal_Name</th><td><?php echo $row1['Name_of_the_Principal_Investigator_Co_Investigator']  ?></td>
                            </tr>
							<tr>
                                <th >Department of Investigator</th><td><?php echo $row1['department_of_investigator']  ?></td>
                            </tr>
							<tr>
                                <th >Funding Agency</th><td><?php echo $row1['Name_of_the_Funding_agency']  ?></td>
                            </tr>
							<tr>
                                <th >type</th><td><?php echo $row1['G_Type']  ?></td>
                            </tr>
                             <tr>
                                 <th >Department of Principal</th><td><?php echo $row1['Department_of_Principal_Investigator_Co_Investigator'] ?></td>
                            </tr>
                          <tr>
                                <th >Year</th><td><?php echo $row1['Year_of_Award'] ?></td>
                            </tr>
							 <tr>
                                <th >Fund</th><td><?php echo $row1['Funds_provided'] ?></td>
                            </tr>
							 <tr>
                                <th >Duretion</th><td><?php echo $row1['Duration_of_the_project'] ?></td>
                            </tr>

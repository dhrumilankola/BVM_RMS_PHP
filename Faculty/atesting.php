...
<head>
  ...
  <title>BRMS |View Testing | Consultancy  Project</title>
              ...
              <div class="card-body">
				...
				<div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $ay;?>" id="aydt" placeholder="2015" name="ay"  tabindex="1" required onblur="test()">
                    </div>
                  </div>
				  <div class="col-sm-2">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $ey;?>" placeholder="2016" name="ey" id="eydt"   tabindex="1" required readonly>
                    </div>
                  </div>
				  <div class="col-sm-2">
                    <!-- text input -->
                ...
                <div class="form-group">
                   ...
                   <input type="file" name="pdfs[]" class="btn btn-info btn-block file" value="<?php echo $upload;?>">
                 </div>
               </div>

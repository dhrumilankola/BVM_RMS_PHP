...
<head>
  ...
  <title>BRMS |Edit STTP |FDP</title>
                ...
                <div class="row">
                  <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="aydt" value="<?php echo $rows['a_y'] ?>"placeholder="2015" name="ay"  tabindex="1" required onblur="test()">
                    </div>
                  </div>
				  <div class="col-sm-2">
                    <!-- text input -->

...
if(isset($_POST['updatework'])){
   ...
   $dpname=$_POST['dpname'];
   $imageData = array();
     $sql1="select * from workshop where workshopid='$_GET[workshopid]'";
...
//             }
       ...
       //$desired_dir="../Faculty/".$row['department']."/".$row['uname']."/".date('Y').'/Workshop/Photos/';
 
 $desired_dir= $rowdid['department']."/". $row['uname']."/".date('Y').'/Workshop/Photos';       
	   ...
	   if(empty($errors)==true){
            ...
            if(is_dir("$desired_dir/".$file_name)==false){
                move_uploaded_file($file_tmp,$rowdid['department']."/". $row['uname']."/".date('Y').'/Workshop/Photos/'.$file_name);
            }else{                  //rename the file if another one exist
                $new_dir=$rowdid['department']."/". $row['uname']."/".date('Y').'/Workshop/Photos/'.$file_name.time();
  ...
  if(empty($error)){
    ...
    $imgDt = implode("|", $imageData);
     ...
     $query= "UPDATE workshop SET a_y='$ay',e_y='$ey',sdate='$sdate',
	 edate='$edate',nod='$nod',name='$name',decr='$decr',mode='$mode',
	 role='$role',user='$user',cu_name='$cuname',dp_name='$dpname',photos='$imgDt' WHERE workshopid='$workshopid'";
      
      if(mysqli_query($link,$query)){
        echo "<script> alert('Workshop  Details Edit Successfully')</script>";
   ...
   if(isset($_GET["workshopid"]) ){
    ...
    $sql = "SELECT * FROM workshop WHERE workshopid = '$workshopid'";
...
<head>
  ...
  <title>BRMS |Edit Workshop</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="vworkshop.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Details</p>
                </a>
              </li>
        ...
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Update Workshop Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <form action="#" method="post" enctype="multipart/form-data">
                <div class="row">
				  ...
				  <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="10" value="<?php echo $rows['nod'] ?>"name="nod"  tabindex="3" required pattern="[0-9]+">
                    </div>
                  </div>
				   <div class="col-sm-6">
                    <!-- text input -->
				  ...
				  <div class="col-sm-4">
                            <div class="form-group">
                                  <label>Users </label>
                                  <select class="form-control" name="user"  tabindex="6" required>
                                    <option>Select here </option>
                                    <option value="Students" <?php 
							if($rows['user']=="Students")
							{
								echo "selected";							}
							?>>Students </option>
                                    <option value="Faculties" <?php 
							if($rows['user']=="Faculties")
							{
								echo "selected";							}
							?>>Faculties</option>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                              <div class="col-sm-12">
                              <input type="submit" class="btn btn-success" name="updatework" value="Submit">

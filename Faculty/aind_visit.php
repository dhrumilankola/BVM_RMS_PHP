...
//             }
       ...
       //$desired_dir="../Faculty/".$row['department']."/".$row['uname']."/".date('Y').'/IndustryVisit/Photos/';
 ...
 $desired_dir= $rowdid['department']."/". $row['uname']."/".date('Y').'/IndustryVisit/Photos';       
  ...
  if(empty($error)){
    ...
    $imgDt = implode("|", $imageData);
     ...
     $query= "UPDATE ind_visit SET a_y='$ay',e_y='$ey',industry_name='$industry_name',ind_city='$ind_city',ind_state='$ind_state',sem='$zip',date='$date',decr='$decr',photos='$imgDt',noofstud='$noofstud' WHERE id='$id'";  
        if(mysqli_query($link,$query)){
          echo "<script>alert('Industrial Visit Details Edit Successfully')</script>";
...
<head>
  ...
  <title>BRMS | Edit Industrial Visit</title>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="vind_visit.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Details</p>
                </a>
              </li>              
        ...
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edit Industrial Visit Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
				...
				<div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  value="<?php echo $rows['a_y'] ?>" id="aydt" name="ay"  tabindex="1" required onblur="test()">
                    </div>
                  </div>
				  <div class="col-sm-2">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  value="<?php echo $rows['e_y'] ?>"  name="ey" id="eydt" tabindex="1" required readonly>
                    </div>
                  </div>
				  <div class="col-sm-3">
                              <!-- text input -->
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                       ...
                       <textarea class="form-control" placeholder="Enter ..."name="decr" value="" required><?php echo $decr;?></textarea>       
                      </div>
                  </div>
                 <div class="col-sm-3">
                          <div class="form-group">
                            <label>City</label>
                            <input type="text" class="form-control" placeholder="Enter ..." name="ind_city" value="<?php echo $ind_city?>" required>
                   ...
                   <div class="col-sm-3">
                          <div class="form-group">
                          <label>State</label>
                          <input type="text" class="form-control" placeholder="Enter ..." name="ind_state" value="<?php echo $ind_state?>" required>
                   ...
                   <div class="col-sm-3">
                          <div class="form-group">
                          <label>Pincode</label>
                          <input type="Number" class="form-control" placeholder="Enter ..." name="zip" value="<?php echo $zip?>" pattern="[0-9]+" required>
                  ...
                  <div class="col-sm-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter ..." name="noofstud" value="<?php echo $noofstud?>" pattern="[0-9]+" required>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                              <div class="col-sm-12">
                              <input type="submit" class="btn btn-success" name="updateind_visit" value="Submit">

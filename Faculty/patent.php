...
<head>
  ...
  <title>BRMS | View Patent Details</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Patent Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM patent where pid=".$_GET['pid'];
...
<!--                    Display Data -->                    
                      ...
                      <table id="vconference"  class="table table-bordered projects">
							...
							<tr>
                                  <th>Date of Approved</th><td><?php echo $new_date ?></td>
                            </tr>
							<tr>
                                  <th>Patent No</th><td><?php echo $row1['patent_no'] ?></td>
                            </tr>
							
							<tr>
                                  <th> Title of The Invention</th><td><?php echo $row1['name'] ?></td>
                            </tr>
							 <tr>
                                <th> Authorised Registered Patent Agent</th><td><?php echo $row1['agent'] ?></td>
                            </tr>
							<tr>
                            ...
                            <tr>
                                 <th> Download Copy</th><td> <?php 
                                           ...
                                           if($row2['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$rowdid['department']."/".$row2['uname']."/".date('Y')."/Patent/Documents/".$row1['docc']."' download='".$row1['docc']."'><i class='fa fa-download'></i></a>";
                                          }
...
//                                        
                                        //echo "<img height='20%' width='80%' src='".$rowdid['department']."/".$row['uname']."/".date('Y')."/Patent/Documents/$img[$i]'/>";
                                        echo "<iframe src='../Faculty/".$rowdid['department']."/".$row2['uname']."/".date('Y')."/Patent/Documents/".$row1['docc']."' style=width:80%></iframe>";    
											} ?>
                            </td></tr>
                            <tr>

      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
                            ...
                            // echo "<td>" . $row1['conid'] . "</td>";
                             ...
                             $rowdid=mysqli_fetch_array($sqldid);
                              ...
                              <td class="project-actions text-left">
                                 ...
                                 <a class="btn btn-warning btn-sm" href="aconference.php?conid=<?php echo $row1['conid']?>"><i class="fas fa-pencil-alt"></i></a>
			...
			<a href="export_con.php" class="btn btn-success ">Export CSV</a><br>
          </div>
          </div>
                  <!-- /.card-body -->
        </div>

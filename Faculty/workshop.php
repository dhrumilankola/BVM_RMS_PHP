...
<head>
  ...
  <title>BRMS | Faculty View Workshop Details</title>
            ...
            <div class="card card-secondary">
              ...
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM workshop where workshopid=".$_GET['workshopid'];
...
<!--                    Display Data -->                    
                      ...
                      <table id="vconference"  class="table table-bordered projects">
							...
							<tr>
                                  <th> Start Date</th><td><?php echo $sdate ?></td>
                            </tr>
							<tr>
                                  <th> End Date</th><td><?php echo $edate ?></td>
                            </tr>
							<tr>
                                  <th>Total_Days</th><td><?php echo $row1['nod'] ?></td>
                            </tr>
							<tr>
							...
							<tr>
                                 <th> Mode</th><td><?php echo $row1['mode'] ?></td>
                            </tr>
							 <tr>
                                 <th> Role</th><td><?php echo $row1['role'] ?></td>
                            </tr>
							<tr>
                                <th> Users</th><td><?php echo $row1['user'] ?></td>
                            </tr>
							<tr>
                            ...
                            <tr>
                                  <th> Download </th><td> <?php 
                                           ...
                                           if($row2['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$rowdid['department']."/".$row2['uname']."/".date('Y')."/Workshop/photos/".$row1['photos']."' download='".$row1['photos']."'><i class='fa fa-download'></i></a>";
                                          }
...
//                                        
                                        echo "<img height='20%' width='80%' src='".$rowdid['department']."/".$row['uname']."/".date('Y')."/Workshop/Photos/$img[$i]'/>";
                                            } ?>
                            </td></tr>
                            <tr>

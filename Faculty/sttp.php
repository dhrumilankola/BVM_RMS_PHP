...
<head>
  ...
  <title>BRMS | View Details STTP | FDP</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View STTP | FDP Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM sttp_fdp where sttpid=".$_GET['sttpid'];
                            ...
                            <tr>
                                  <th> Download </th><td> <?php 
                                           ...
                                           if($row2['user_type'] == 'Faculty')
                                             { 
                                               echo "<a class='btn btn-info btn-sm' href='../Faculty/".$rowdid['department']."/".$row2['uname']."/".date('Y')."/Sttp/photos/".$row1['photos']."' download='".$row1['photos']."'><i class='fa fa-download'></i></a>";
                                          }
...
//                                        
                                        echo "<img height='20%' width='80%' src='".$rowdid['department']."/".$row['uname']."/".date('Y')."/Sttp/Photos/$img[$i]'/>";
                                            } ?>
                            </td></tr>
                            <tr>

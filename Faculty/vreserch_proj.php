          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Research Projects Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
                            ...
                            echo "<td>" . $row1['a_y'].'-' .$row1['e_y'] . "</td>";
                             echo "<td>" . $row1['project_name'] . "</td>";
                              ...
                              <td class="project-actions text-left">
                                <a class="btn btn-info btn-sm" href="reserch_proj.php?projectid=<?php echo $row1['projectid']?>"><i class="fas fa-eye"></i></a>
                                <a class="btn btn-warning btn-sm" href="aresearch_proj.php?projectid=<?php echo $row1['projectid']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deletereserch_proj.php?projectid=<?php echo $row1['projectid']?>"><i class="fas fa-trash"></i></a>
                              <!-- </div> -->
                              </td>
			...
			<a href="export_res.php" class="btn btn-success ">Export CSV</a><br>
          </div>
          </div>
                  <!-- /.card-body -->
        </div>

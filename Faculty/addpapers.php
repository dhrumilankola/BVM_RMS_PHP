...
//             }
        ...
        $desired_dir=$rowdid['department']."/". $row['uname']."/".date('Y').'/Papers/Documents/';
        if(empty($errors)==true){
            if(is_dir($desired_dir)==false){
                mkdir("$desired_dir", 0700);    // Create directory if it does not exist
            }
            if(is_dir("$desired_dir/".$file_name)==false){
                move_uploaded_file($file_tmp,$rowdid['department']."/". $row['uname']."/".date('Y').'/Papers/Documents/'.$file_name);
            }else{                  //rename the file if another one exist
                $new_dir=$rowdid['department']."/". $row['uname']."/".date('Y').'/Papers/Documents/'.$file_name.time();
  ...
  if(empty($error)){
     $pdfs = implode("|", $imageData);
      $query="INSERT INTO papers (a_y ,e_y ,title ,no_at ,fat ,sat ,tat ,ffat,
	  cj_name ,paper_type ,isbn ,doi ,v_i ,mp ,yp,impact ,aid,pdf)
VALUES ('$ay','$ey','$pt','$not','$fat','$sat','$tat','$ffat',
	  '$cjname','$pty','$isbn','$doi','$voi', '$mp','$yp','$imp','$session_aid','$pdfs')";
...
<head>
  ...
  <title>BRMS|Add  Papers Details</title>
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="addpapers.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Details</p>
                  </a>
                </li>
   ...
   <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Add Published Research Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
		...
		function frmselect(){				
			...
			if(madeas(pty, "Please Select Paper Type ")){
									return true;
			...
			if(elem.value == "Select here"){
				...
				<div class="col-sm-2">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  tabindex="3" placeholder="Mobile Adhoc Network" name="pt" required>
                    </div>
                  </div>            
                 <div class="col-sm-2">
                            <div class="form-group">
                                  <label>No of Author </label>
                                  <select class="form-control" name="not"  tabindex="4" id='not' required>
				...
				<div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  tabindex="8" placeholder="Dr.Vatsal Shah" name="ffat">
                    </div>					
                </div>
				<div class="col-sm-5">
                    <div class="form-group">
                      <label>Conference | Journal Name</label>
                      <input type="text" class="form-control"  tabindex="9" placeholder="Information Security" name="cjname" required >
                    </div>					
                </div>
				<div class="col-sm-3">
                            <div class="form-group">
                                  <label>Paper Type </label>
                                  <select class="form-control" name="pty"  tabindex="10" id='pty' required>
                                    <option>Select here </option>
				...
				<div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" tabindex="11" placeholder="ISBN 13: 978-0-13-609704-4" name="isbn" required >
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>DOI Number</label>
                      <input type="text" class="form-control"  tabindex="12" placeholder="Enter...." name="doi" >
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>Volume and Issue</label>
                      <input type="text" class="form-control"  tabindex="13" placeholder="Enter..." name="voi">
                    </div>					
                </div>
				<div class="col-sm-2">
                    <div class="form-group">
                      <label>Month of Publication</label>
                      <input type="text" class="form-control"  tabindex="14" placeholder="March" name="mp">
                    </div>					
                </div>
				<script type='text/javascript'>
			...
			if(elem.value.match(numericExpression)){
				...
				<div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="2019" tabindex="15"   id='nd'name="yp" required onchange="frmnod()" >
                    </div>					
                </div>
				<div class="col-sm-2">
                    <div class="form-group">
                      <label>Impact Factor</label>
                      <input type="text" class="form-control"  tabindex="16" placeholder="3.4" name="imp" required >
                    </div>					
                </div>
              ...
              <div class="col-sm-3">
                <div class="form-group">
                   <input type="file" name="pdfs[]" tabindex="17"  class="btn btn-info btn-block file" required>
                 </div>
               </div>
                <div class="row">
                  ...
                  <div class="col-sm-12">
                              <div class="col-sm-12">
                              <input type="submit" class="btn btn-success" tabindex="18"  name="addpaper" value="Submit">
                           <button type="reset" class="btn btn-danger float-right"  tabindex="19"><i class="glyphicon glyphicon-repeat"></i>Reset</button>       
                  </div>
                  </div>
                </div>
                <!-- /.row -->

...
<head>
  ...
  <title>BRMS |Expert Talk/Session Chair</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="vsession_chair.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Details</p>
                </a>
              </li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Expert Talk/Session Chair  Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
               ...
               <?php  
                      ...
                      $sql = "SELECT * FROM expert where aid='$session_aid'";
                      ...
                      <table id="vclient"  class="table table-bordered projects">
                        ...
                        <?php
                          while($row1 = mysqli_fetch_array($result)){
                            ?>
                            <tr><?php
							$timestamp = strtotime($row1['strat_date']);
							$sdate = date("d-m-Y",$timestamp );
							$timestamp = strtotime($row1['end_date']);
                            ...
                            // echo "<td>" . $row1['conid'] . "</td>";
                              ...
                              $rowdid=mysqli_fetch_array($sqldid);
							  echo "<td>" . $row1['start_year'].'-' .$row1['end_year'] . "</td>";
							   echo "<td>" . $sdate  . "</td>";
							  echo "<td>" . $edate . "</td>";
							  echo "<td>" . $row1['total_days'] . "</td>";
                             echo "<td>" . $row1['topic_name'] . "</td>";                              
                               echo "<td>" . $row1['mode'] . "</td>";
							   echo "<td>" . $row1['role'] . "</td>";
								
								//echo "<td>" . $row1['clg_name'] . "</td>"; 
...
//                               
                            ...
                            elseif($row2['user_type']=='Admin'){
                              ...
                              <td class="project-actions text-left">
                                <a class="btn btn-info btn-sm" href="session_chair.php?id=<?php echo $row1['id']?>"><i class="fas fa-eye"></i></a>
                                <a class="btn btn-warning btn-sm" href="asession_chair.php?id=<?php echo $row1['id']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deletesession_chair.php?id=<?php echo $row1['id']?>"><i class="fas fa-trash"></i></a>
                              <!-- </div> -->
                              </td>
			...
			<a href="export_session.php" class="btn btn-success ">Export CSV</a><br>
          </div>
          </div>
                  <!-- /.card-body -->
        </div>

...
<head>
  ...
  <title>BRMS | View Industrial Visit</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Industrial Visits</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
                      ...
                      <table id="vclient"  class="table table-bordered projects">
                        ...
                        <?php
                         ...
                         $sql1="select * from user where aid='$row1[aid]'";
                            ...
                            echo "<td >" . $new_date . "</td>";
                             echo "<td>" . $row1['industry_name'] . "</td>";
                              echo "<td>" . $row1['ind_city'] . "</td>";
                              echo "<td>" . $row1['ind_state'] . "</td>";
                               
                              echo "<td>" . $row1['sem'] . "</td>";
                               echo "<td style=width:100px>" . $row1['noofstud'] . "</td>";
//                              echo "<td>". count(explode("|",$row1['photos']))."</td>";                                  
                             //   if($row2['user_type']=='Faculty')
                             //  {  
                             //   echo "<td><img style=width:100px;height:80px; src='../Faculty/".$rowdid['department']."/". $row2['uname']."/".date('Y')."/IndustryVisit/Photos/". $row1['photos'] . "'/></td>";
                             // }
                             // elseif($row2['user_type']=='Admin'){
                             //  echo "<td><img style=width:100px;height:80px; src='../admin/IndustryVisit/".date('Y')."/". $row1['photos']. "'/></td>";
                             // }
                              ?>
                              <td class="project-actions text-left">
                                 <a class="btn btn-info btn-sm" href="ind_visit.php?id=<?php echo $row1['id']?>"><i class="fas fa-eye"></i></a>
                                <a class="btn btn-warning btn-sm" href="aind_visit.php?id=<?php echo $row1['id']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deleteind_visit.php?id=<?php echo $row1['id']?>"><i class="fas fa-trash"></i></a>
                              </td>
			...
			<a href="export_visit.php" class="btn btn-success ">Export CSV</a><br>
          </div>
          </div>
                  <!-- /.card-body -->
        </div>

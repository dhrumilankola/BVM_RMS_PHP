  ...
  if(in_array($rfileActualExt, $rallowed)) {
     $resume=uniqid('',true).".".$rfileActualExt;
      ...
      move_uploaded_file($_FILES['resume']['tmp_name'],$rdir);
    	...
    	$sql= "UPDATE user SET uname='$uname',mno='$mno',gender='$gender',email='$email',
		city='$city',bday='$bday',addr='$addr',zip='$zip',user_type='$user_type',
		did='$did',desig ='$desig',doj='$doj',schlspec='$schlspec',
		school='$school',yschool='$yschool',rschool='$rschool',hspec='$hspec',
		hschool='$hschool',hyear='$hyear',hresult='$hresult',dspec='$dspec',
		sdiploma='$sdiploma',ydiploma='$ydiploma',rdiploma='$rdiploma',
		degreespec='$degreespec',degree='$degree',ydegree='$ydegree',
		rdegree='$rdegree',pgspec='$pgspec',pg='$pg',ypg='$ypg',rpg='$rpg',
		otherspec='$otherspec',sothers='$sothers',yothers='$yothers'
		,rothers='$rothers',profile='$profile',resume='$resume',pass='$pass',
		cpass='$pass' WHERE aid='$_GET[aid]'";
...
<head>
  ...
  <title>BRMS |Admin Edit Employee </title>
    ...
    <li class="nav-item btn-group">
      ...
      <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: white; color: black; border: none; padding-top: 0px; ">
         <li class="nav-item ">
          ...
          if($rows['profile']){
          ?>
        <img src="../images/<?php echo $rows['profile']; ?>" alt="User Avatar" class="img-size-50 img-circle ">
        <?php }
        else {
        ?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <a href="index.php" class="brand-link">
    ...
    <div class="sidebar">
        ...
        <?php 
            $sqldid=mysqli_query($link,"select * from Department WHERE did='$rows[did]'");
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                       <label>User Type</label>
                           <select name="user_type" class="form-control" value="<?php echo $user_type; ?>" readonly>

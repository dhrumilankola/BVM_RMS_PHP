 ...
 $desired_dir= $rowdid['department']."/". $row['uname']."/".date('Y').'/IndustryVisit/Photos';       
  ...
  if(empty($error)){
    ...
    $imgDt = implode("|", $imageData);
     ...
     $query= "UPDATE ind_visit SET a_y='$ay',e_y='$ey',industry_name='$industry_name',ind_city='$ind_city',ind_state='$ind_state',zip='$zip',date='$date',decr='$decr',photos='$imgDt',noofstud='$noofstud' WHERE id='$id'";  
...
<head>
  ...
  <title>BRMS |Admin View Industrial Visits</title>
              ...
              <div class="card-body">
				...
				<div class="col-sm-2">
					...
					<script>
                      ...
                      <input type="text" class="form-control" id="aydt"  value="<?php echo $rows['a_y'] ?>"  name="ay"  tabindex="1" required onchange="test()">
                    </div>
                  </div>
				  <div class="col-sm-2">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  id="eydt"  value="<?php echo $rows['e_y'] ?>"  name="ey"  tabindex="1" required readonly>
                    </div>
                  </div>
				  <div class="col-sm-3">
                              <!-- text input -->
                 ...
                 <div class="col-sm-3">
                   ...
                   <div class="col-sm-3">
                          ...
                          <input type="Number" class="form-control" placeholder="Enter ..." name="zip" value="<?php echo $zip?>">
                ...
                <div class="form-group">
                  <label>Upload Photos</label>
                   <input type="file" name="photos[]" class="btn btn-info btn-block file" multiple value="<?php echo $photos?>" required>
                 </div>
               </div>
              </div>

...
if(isset($_POST['updatepatent'])){
   ...
   $agent=$_POST['agent'];
        ...
        $sql1="select * from patent where pid='$_GET[pid]'";
 ...
 $file_type=$_FILES['pdfs']['type'][$key];
    ...
    {
   $desired_dir= '../Faculty/'.$rowdid['department']."/".$row3['uname']."/".date('Y').'/Patent/Documents';
 }
 ...
 {
     $sql= "UPDATE patent SET a_y='$ay',name='$name',date='$date',
	 patent_no='$pn',agent='$agent',decr='$decr'
	 ,docc='$pdfs' WHERE pid='$pid'";
      
        if(mysqli_query($link, $sql) )
        {
          echo "<script>alert('Patent Edit Successfully')</script>";
              header('location:vpatent.php');
        }
          else
          header('location:apatent.php');
}
}
}}}}}
else{
   if(isset($_GET["pid"])){
    ...
    $sql = "SELECT * FROM patent WHERE pid = '$pid'";
...
<head>
  ...
  <title>BRMS |Admin Edit Patents </title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview">
            <a href="vpatent.php" class="nav-link active">
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-2">
					...
					<script>
                      ...
                      <input type="text" class="form-control" value="<?php echo $ay;?>" placeholder="2015"  id="aydt" name="ay"  tabindex="1" required onchange="test()">
                    </div>
                  </div>
				  <div class="col-sm-2">
                    <!-- text input -->
				  ...
				  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                ...
                                <input type="date"  class="form-control" value="<?php echo $date;?>"  name="date"  tabindex="2" required pattern="\Y{4}-\m{2}-\d{2}">
				  ...
				  <div class="col-sm-5">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $pn;?>" placeholder="2015-2016" name="pn"  tabindex="1" required>
                    </div>
                  </div>
				   <div class="col-sm-6">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $name;?>" placeholder="Pedagogy & Effective use of ICT in Engineering Education & Academic Governance" name="title"  tabindex="4" required>
                    </div>
                  </div>
				  ...
				  <div class="col-sm-6">
                              <!-- text input -->
                              <div class="form-group">
                                <label> Authorised Registered Patent Agent</label>
                                <input type="text" class="form-control" value="<?php echo $agent;?>"  tabindex="9" placeholder="Birla Vishvakarma Mahavidyalaya " name="agent">
				  ...
				  <div class="col-sm-5">
                    <div class="form-group">
                     ...
                     <textarea class="form-control" placeholder="Enter ..."name="decr" tabindex="5" > <?php echo $decr;?></textarea>
                    </div>
                </div>
				
                   <div class="col-sm-4">
                <div class="form-group">
                  <label>Upload Document(.pdf format)</label>
                   <input type="file" name="pdfs[]" class="btn btn-info btn-block file"   value="<?php echo $pdfs;?>" tabindex="11" multiple>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="col-sm-12">
                    <input type="submit" class="btn btn-success" name="updatepatent"  tabindex="13" value="Submit">

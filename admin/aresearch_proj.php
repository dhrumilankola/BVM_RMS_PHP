...
if(isset($_POST['updateproject'])){
	...
	$decr=$_POST['decr'];
     ...
     $sql1="select * from reserch_proj where projectid='$_GET[projectid]'";
...
foreach($_FILES['pdfs']['tmp_name'] as $key => $tmp_name ){
 ...
 $file_type=$_FILES['pdfs']['type'][$key];
    ...
    {
   $desired_dir= '../Faculty/'.$rowdid['department']."/".$row3['uname']."/".date('Y').'/Projects/Documents';
 }
 elseif($row3['user_type']=='Admin'){
   $desired_dir="../admin/Projects/".date('Y')."/";
 }
 if(move_uploaded_file($file_tmp,"$desired_dir/".$pdfs))
 {
      $query= "UPDATE reserch_proj SET a_y='$ay',e_y='$ey',project_name='$pname',
	  startdate='$sdate',enddate='$edate',role='$role',agency_name='$an',
	  amount='$amount',sanction_letter_no='$sln',decr='$decr',upload='$pdfs' WHERE projectid='$projectid'";
        if(mysqli_query($link,$query)){
          echo "<script>alert('Project Edit Successfully')</script>";
   ...
   if(isset($_GET["projectid"]) ){    
    ...
    $sql = "SELECT * FROM reserch_proj WHERE projectid = '$projectid'";
...
<head>
  ...
  <title>BRMS |Admin View Research Papers</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="vreserch_proj.php" class="nav-link active">
        ...
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edit Research Project Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">

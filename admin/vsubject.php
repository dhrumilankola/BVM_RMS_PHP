...
$sql= "INSERT INTO subjects(Name,did) VALUES ('$name','$did')";
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                ...
                <div class="col-sm-6">
                 ...
                 <div class="col-sm-4">
                      <input type="submit" class="btn btn-info" name="addsub" value="submit" style="margin-bottom: 32px">
                  </div>
                </div>
              <!-- </form> -->
              <div class="row">
               ...
               <?php  
                      ...
                      if(mysqli_num_rows($result) > 0){ 
                       ...
                       ?>
                      <table id="vsub"  class="table table-bordered projects">
                        <thead>
                              <tr>
                              <th> ID</th>  
                              <th>Subject</th>                 
                        ...
                        <?php
                          while($row1 = mysqli_fetch_array($result)){
                            $sql1="select * from department where did='$row1[did]'";
                            ...
                            <tr><?php
                            echo "<td>" . $row1['subid'] . "</td>";
                            // echo "<td style=width:10px>" . $row1['date'] . "</td>";
                             echo "<td>" . $row1['Name'] . "</td>";
                             echo "<td>" . $row2['department'] . "</td>";
                            // echo" <iframe src='".$row['uname']."/Papers/".date('Y')."/". $row1['pdf'] . "'></iframe><br>";
                           

                               // echo "<td style=width:15%><iframe src='../Faculty/".$row2['uname']."/Papers/".date('Y')."/". $row1['pdf'] . "' style=width:100%></iframe></td>";
                              ?>
                              <td class="project-actions text-left">
                                
                                <a class="btn btn-info btn-sm" href="asubject.php?subid=<?php echo $row1['subid']?>"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" href="deletesubject.php?subid=<?php echo $row1['subid']?>"><i class="fas fa-trash"></i></a>
                              <!-- </div> -->
                              </td>

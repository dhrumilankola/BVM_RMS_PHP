...
//             }        
  ...
  if(empty($error)){
     ...
     $query="INSERT INTO ind_visit (industry_name,ind_city,ind_state, zip,date ,decr,photos , aid ,noofstud)VALUES ('$industry_name','$ind_city','$ind_state','$zip','$date','$decr','$photos','$session_aid','$noofstud')";
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter ..." name="industry_name" required >
                    </div>
                  </div>
                   <div class="col-sm-4">
                 ...
                 <div class="col-sm-3">
                          <div class="form-group">
                                        <label>City</label>
                                        <input type="text" class="form-control" placeholder="Enter ..." name="ind_city" required>
                   ...
                   <div class="col-sm-3">
                          <div class="form-group">
                                        <label>State</label>
                                        <input type="text" class="form-control" placeholder="Enter ..." name="ind_state" required>
                   ...
                   <div class="col-sm-2">
                          <div class="form-group">
                                        <label>Pincode</label>
                                        <input type="text" class="form-control" placeholder="Enter ..." name="zip" required>
                ...
                <!-- <div class="row"> -->
                  ...
                  <div class="col-sm-3">
                      ...
                      <input type="text" class="form-control" placeholder="Enter ..." name="noofstud" required>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                  <div class="col-sm-12">
                  <input type="submit" class="btn btn-info" name="addind_visit" value="submit">

                  ...
                  <div class="col-sm-1.2">
                   ...
                   <div class="col-sm-1.2">
                      ...
                      //     while($rowsem = mysqli_fetch_array($res_sem)){
                            ...
                            <tr>
                              <?php
                             $sql1="select * from user where aid='$rowind[aid]'";
                                        if($result1 = mysqli_query($link, $sql1)){
                                           while($row2 = mysqli_fetch_array($result1)){
                              echo "<td>" . $rowind['id'] . "</td>";
                            echo "<td style=width:10px>" . $rowind['date'] . "</td>";
                             echo "<td>" . $rowind['industry_name'] . "</td>";
                              echo "<td>" . $rowind['ind_city'] . "</td>";
                              echo "<td>" . $rowind['ind_state'] . "</td>";
                               echo "<td>" . $row2['uname'] . "</td>";
                              echo "<td>" . $rowind['zip'] . "</td>";
                               echo "<td style=width:100px>" . $rowind['noofstud'] . "</td>";    
                               echo "<td><img style=width:100px;height:80px; src='../Faculty/".$row2['uname']."/IndustryVisit/".date('Y')."/". $rowind['photos'] . "'/></td>";

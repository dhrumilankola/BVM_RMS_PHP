...
<head>
  ...
  <title>BRMS |Admin View Profile</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     <div class="container-fluid">
        <div class="row">
          <form action="editprofile.php?aid=<?php echo $session_aid;?>" method="post" enctype="multipart/form-data">
            <div class="col-sm-12">
                 <div class="card  card-secondary">
                    ...
                    <div class="card-body ">
                      ...
                      <div class="row">
                        ...
                        <div class="col" style="margin-left: 25px;">
                         ...
                         <div class="row" style="margin-bottom: -10px;margin-left: 25px;" >
                          ...
                          <div class="row" style="margin-bottom: -10px;margin-left: 35.5%;">
                             <div class="form-group" style="color: black">
                         ...
                         <div class="row" style="margin-bottom: -10px;margin-left: 25px;" >
                          <div class="row" style="margin-bottom: -10px;">
                             <div class="form-group" style="color: black">
                              ...
                              <div class="row" style="margin-bottom: -10px;margin-left: 31.5%;">
                             ...
                             <div class="form-group" style="color: black">
                              ...
                              <div class="row" style="margin-bottom: -10px;margin-left:14.3%;">
                                 <div class="form-group" style="color: black">
                      ...
                      <div class="col-sm-15" style="margin-right: 60px;margin-bottom: 7%">
                        <div class="img thumbnail">
                           ...
                           <?php if($row['profile']!="") {
                              echo "<img src = '../images/".$row['profile']."'class='img-responsive' width='150' height='180'>";
                    ...
                    <form  method="post" enctype="multipart/form-data">
                      <!-- action="aintsubtask.php?itid=<?php echo $itid?>" -->
                        <div class="card-body">

...
//             }
        ...
        $desired_dir='Books/'.date('Y');
        if(empty($errors)==true){
            if(is_dir($desired_dir)==false){
                mkdir("$desired_dir", 0700);    // Create directory if it does not exist
            }
            if(is_dir("$desired_dir/".$file_name)==false){
                move_uploaded_file($file_tmp,'Books/'.date('Y')."/".$file_name);
            }else{                  //rename the file if another one exist
                $new_dir='Books/'.date('Y')."/".$file_name.time();
  ...
  if(empty($error)){
     $pdfs = implode("|", $imageData);
      $query="INSERT INTO book (`name`, `typeofwork`, `subid`, `aid`, `total_pages`, `descr`, `docc`, `created_at`)
VALUES ('$name', 'BOOK', '$subid', '$session_aid', '$total_pages', '$decr', '$pdfs')";
            ...
            <div class="card card-secondary">
                  ...
                  <div class="col-sm-2.5">
                   ...
                   <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" placeholder="Enter ..." name="total_pages" required >
                    </div>
                </div>
                  <div class="col-sm-3">
                      <div class="form-group">
              ...
              <div class="col-sm-3">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                              <div class="col-sm-12">
                              <input type="submit" class="btn btn-info" name="addbook" value="submit">

...
if(isset($_POST['updatepaper'])){
 ...
 $sql1="select * from papers where paperid='$_GET[paperid]'";
 ...
 $file_type=$_FILES['pdfs']['type'][$key];
    ...
    {
   $desired_dir= '../Faculty/'.$rowdid['department']."/".$row3['uname']."/".date('Y').'/Papers/Documents';
 }
 elseif($row3['user_type']=='Admin'){
   $desired_dir="../admin/Papers/".date('Y')."/";
 }
 if(move_uploaded_file($file_tmp,"$desired_dir/".$pdfs))
 {
    
      $query= "UPDATE papers SET a_y='$ay',e_y='$ey',title='$pt',no_at='$not',fat='$fat',sat='$sat',
					tat='$tat',ffat='$ffat',cj_name='$cjname',paper_type='$pty'
					,isbn='$isbn',doi='$doi',v_i='$voi'	,mp='$mp',yp='$yp'
					,impact='$imp',pdf='$pdfs' WHERE paperid='$paperid'";
      
        if(mysqli_query($link,$query)){
          echo "<script>alert('Paper Edit Successfully')</script>";
   ...
   if(isset($_GET["paperid"]) ){
    ...
    $sql = "SELECT * FROM papers WHERE paperid = '$paperid'";
...
<head>
  ...
  <title>BRMS |Admin Edit Research Papers</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="vpaper.php" class="nav-link active">
        ...
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edit Published Research Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
				...
				<div class="col-sm-2">
					...
					<script>
                      ...
                      <input type="text" class="form-control"  id="aydt" value="<?php echo $ay; ?>"placeholder="2015" name="ay"  tabindex="1" required onchange="test()">
                    </div>
                  </div>
				  <div class="col-sm-2">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" readonly value="<?php echo $ey; ?>"placeholder="2016" name="ey"  id="eydt" tabindex="1" required>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $pt; ?>" placeholder="Mobile Adhoc Network" name="pt" required>
                    </div>
                  </div>            
                 <div class="col-sm-2">
                            <div class="form-group">
                                  <label>No of Author </label>
                                  <select class="form-control" name="not"  tabindex="6" required>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $fat; ?>" placeholder="Dr.Indrajit N.Patel " name="fat" required >
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>2nd Author Name</label>
                      <input type="text" class="form-control" value="<?php echo $sat; ?>" placeholder="Dr.Keyur Nayankumar Brahmbhatt" name="sat">
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>3rd Author Name</label>
                      <input type="text" class="form-control"  value="<?php echo $tat; ?>"placeholder="Dr.J.M.Rathod" name="tat">
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>4th Author Name</label>
                      <input type="text" class="form-control"  value="<?php echo $ffat; ?>"placeholder="Dr.Vatsal Shah" name="ffat">
                    </div>					
                </div>
				<div class="col-sm-5">
                    <div class="form-group">
                      <label>Conference | Journal Name</label>
                      <input type="text" class="form-control"  value="<?php echo $cjname; ?>"placeholder="Information Security" name="cjname" required >
                    </div>					
                </div>
				<div class="col-sm-3">
                            <div class="form-group">
                                  <label>Paper Type </label>
                                  <select class="form-control" name="pty"  tabindex="6" required>
                                    <option>Select here </option>
                                    <option value="Paper Published" <?php 
							if($rows['paper_type']=="Paper Published")
							{
								echo "selected";							}
							?>>Paper Published </option>
                                    <option value="Paper Presented" <?php 
							if($rows['paper_type']=="Paper Presented")
							{
								echo "selected";							}
							?>>Paper Presented</option>
									<option value="Boths" <?php 
							if($rows['paper_type']=="Boths")
							{
								echo "selected";							}
							?>>Boths</option>	
				...
				<div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $isbn; ?>" placeholder="ISBN 13: 978-0-13-609704-4" name="isbn" required >
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>DOI Number</label>
                      <input type="text" class="form-control" value="<?php echo $doi; ?>" placeholder="Enter...." name="doi" >
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>Volume and Issue</label>
                      <input type="text" class="form-control"  value="<?php echo $voi; ?>"placeholder="Enter..." name="voi">
                    </div>					
                </div>
				<div class="col-sm-2">
                    <div class="form-group">
                      <label>Month of Publication</label>
                      <input type="text" class="form-control"  value="<?php echo $mp; ?>"placeholder="March" name="mp">
                    </div>					
                </div>
				<div class="col-sm-2">
                    <div class="form-group">
                      <label>Year of Publication</label>
                      <input type="text" class="form-control"value="<?php echo $yp; ?>" placeholder="2019" name="yp" required >
                    </div>					
                </div>
				<div class="col-sm-2">
                    <div class="form-group">
                      <label>Impact Factor</label>
                      <input type="text" class="form-control"value="<?php echo $imp; ?>"  placeholder="3.4" name="imp" required >
                    </div>					
                </div>
              ...
              <div class="col-sm-3">
                <div class="form-group">
                   <input type="file" name="pdfs[]" class="btn btn-info btn-block file" multiple style="height: 40px" value="<?php echo $pdf; ?>">
                 </div>
               </div>
                <div class="row">
                  ...
                  <div class="col-sm-12">
                              <div class="col-sm-12">
                              <input type="submit" class="btn btn-success" name="updatepaper" value="Submit">

                  ...
                  <div class="col-sm-1.2">
                   ...
                   <div class="col-sm-1.2">
                      ...
                      //     while($rowsem = mysqli_fetch_array($res_sem)){
                            ...
                            <tr>
                              <?php
                             $sql1="select * from user where aid='$rowcon[aid]'";
                                        if($result1 = mysqli_query($link, $sql1)){
                                           while($row2 = mysqli_fetch_array($result1)){
                             echo "<td>" . $rowcon['name'] . "</td>";
                              echo "<td>" . $rowcon['attend_as'] . "</td>";
                               echo "<td>" . $rowcon['type'] . "</td>"; 
                                 echo "<td>" . $row2['uname'] . "</td>";    
                              echo "<td>" . $rowcon['date'] . "</td>";
                              echo "<td class=col-md-0>" . $rowcon['start_time'] . "</td>";
                              echo "<td>" . $rowcon['end_time'] . "</td>";
                               echo "<td><img style=width:100px;height:80px; src='../Faculty/".$row2['uname']."/Conference/".date('Y')."/". $rowcon['photos'] . "'/></td>";

      ...
      {  
           $sqld=mysqli_query($link,"SELECT * from department where did=$row1[did]");
                            ...
                            echo "<tr>";
                             ...
                             echo"<a class=btn btn-info btn-sm href='editemp.php?aid=".$row1['aid']."><i class=fas fa-pencil-alt></i></a>";
                               echo"<a class=btn btn-danger btn-sm href=deleteemp.php?aid=". $row1['aid']."><i class=fas fa-trash></i></a>";
                             echo"</td>";
                              echo "</tr>";
...
<head>
  ...
  <title>BRMS |Admin View Employee </title>
                          ...
                          while($row = mysqli_fetch_array($result)){
                            ...
                            <tr>
                              ...
                              <td class="project-actions text-left">
                                ...
                                <a class="btn btn-warning btn-sm" href="editemp.php?aid=<?php echo $row['aid']?>"><i class="fas fa-pencil-alt"></i></a>

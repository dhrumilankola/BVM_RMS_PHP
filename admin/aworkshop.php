...
<head>
  ...
  <title>BRMS |Admin View Workshop</title>
                ...
                <div class="row">
				  ...
				  <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" readonly value="<?php echo $rows['e_y'] ?>"placeholder="2015" name="ey" id="eydt" tabindex="1" required>
                    </div>
                  </div>
				  <div class="col-sm-3">
                              <!-- text input -->

...
if(isset($_POST['updateproject'])){
    ...
    $sln=$_POST['sln'];
	$decr=$_POST['decr'];
     $sql1="select * from testing where tid='$_GET[tid]'";
...
foreach($_FILES['pdfs']['tmp_name'] as $key => $tmp_name ){
 ...
 $file_type=$_FILES['pdfs']['type'][$key];
    ...
    {
   $desired_dir= '../Faculty/'.$rowdid['department']."/".$row3['uname']."/".date('Y').'/Testing_Consultancy/Documents';
 }
 elseif($row3['user_type']=='Admin'){
   $desired_dir="../admin/Testing_Consultancy/".date('Y')."/";
 }
 if(move_uploaded_file($file_tmp,"$desired_dir/".$pdfs))
 {
     
      $query= "UPDATE testing SET a_y='$ay',e_y='$ey', work_type='$wt',project_name='$pname',
	  startdate='$sdate',enddate='$edate',role='$role',agency_name='$an',
	  amount='$amount',sanction_letter_no='$sln',decr='$decr',upload='$pdfs' WHERE tid='$tid'";
        if(mysqli_query($link,$query)){
          echo "<script>alert('Testing Project Edit Successfully')</script>";
   ...
   if(isset($_GET["tid"]) ){    
    ...
    $sql = "SELECT * FROM testing WHERE tid = '$tid'";
...
<head>
  ...
  <title>BRMS |Admin Edit Testing | Consultancy </title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview">
            <a href="vtesting.php" class="nav-link active">
        ...
        <div class="row">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edit Testing | Consultancy Project Details</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
				...
				<div class="col-sm-2">
				  ...
				  <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control"   tabindex="8" name="wt">
                                    <option>Select here </option>
                                    <option value="Testing"<?php 
							if($rows['work_type']=="Testing")
							{
								echo "selected";							}
							?>  >Testing  </option>
                                     <option value="Consultancy"<?php 
							if($rows['work_type']=="Consultancy")
							{
								echo "selected";							}
							?> >Consultancy</option>
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $pname;?>"placeholder="Enter ..." name="pname" required >
                    </div>
                  </div>
                   ...
                   <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" value="<?php echo $sdate;?>"placeholder="Enter ..." name="sdate" required>
                    </div>
                </div>
                 <div class="col-sm-2">
                    <div class="form-group">
                      <label>End Date</label>
                      <input type="date" class="form-control"  value="<?php echo $edate;?>"placeholder="Enter ..." name="edate" required>
                    </div>
                </div>
				<div class="col-sm-3">
                            <div class="form-group">
				  ...
				  <div class="col-sm-5">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control"  value="<?php echo $an;?>" tabindex="9" placeholder="DST  " name="an" required>
				  ...
				  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                <label>Amount</label>
                                <input type="text" class="form-control" value="<?php echo $amount;?>"  tabindex="9" placeholder="1,00,000 " name="amount" required>
                                <!-- data-date-format="DD MMMM YYYY" -->
                              </div>
                  </div>
				  <div class="col-sm-4">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control"  value="<?php echo $sln;?>" tabindex="9" placeholder="DST-Gujcost-12112019 " name="sln" required>
                                <!-- data-date-format="DD MMMM YYYY" -->
                              </div>
                  </div>
				  <div class="col-sm-5">
                    ...
                    <div class="form-group">
                     ...
                     <textarea class="form-control" value=""placeholder="Enter ..."name="decr" required> <?php echo $decr;?></textarea>
                    </div>
                  </div>
                  <div class="col-sm-3">
                <div class="form-group">
                    <label>Upload Project Report</label>
                   <input type="file" name="pdfs[]" class="btn btn-info btn-block file" value="<?php echo $upload;?>"  multiple>
                 </div>
               </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                      <div class="col-sm-12">
                    <input type="submit" class="btn btn-success" name="updateproject" value="Submit">     

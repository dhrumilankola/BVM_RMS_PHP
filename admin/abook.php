      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
				...
				<div class="col-sm-2">
				  ...
				  <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $rows['e_y'];?>" placeholder="2016" name="ey" id="eydt" readonly tabindex="1" required>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <!-- text input -->
				...
				<div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $rows['bp'];?>" placeholder="450 Rs" name="bp" required >
                    </div>					
                </div>
				<div class="col-sm-3">
                    <div class="form-group">
                      <label>Year of Publication</label>
                      <input type="text" class="form-control" value="<?php echo $rows['yp'];?>" placeholder="2019" name="yp" required >
                    </div>					
                </div>
				<div class="col-sm-4">
                    <div class="form-group">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                   <input type="file" name="pdfs[]" class="btn btn-info btn-block file" multiple>
                 </div>
               </div>
                <div class="row">
                  <div class="col-sm-12">

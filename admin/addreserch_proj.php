...
//             }
  ...
  if(empty($error)){
     $upload = implode("|", $imageData);
      $query="INSERT INTO reserch_proj (name,subid, aid, fromdate,todate ,decr,upload)
VALUES ('$name','$subid','$session_aid','$fromdate','$todate','$decr','$upload')";
...
<head>
  ...
  <title>Birla Vishvakarma Mahavidyalaya | Projects</title>
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                   ...
                   <input type="file" name="upload[]" class="btn btn-info btn-block file" multiple>
                 </div>
               </div>
                <div class="col-sm-6">
                    <!-- text input -->
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                      <div class="col-sm-12">
                    <input type="submit" class="btn btn-info" name="addproject" value="submit">     
                  </div>
                  </div>
                </div>
                <!-- /.row -->

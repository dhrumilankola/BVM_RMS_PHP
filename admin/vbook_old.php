                      ...
                      <table id="vbook"  class="table table-bordered projects">
                        ...
                        <?php
                          while($row1 = mysqli_fetch_array($result)){
                            $sql1="SELECT * FROM subjects where subid='$row1[subid]'";
                            ...
                            echo "<td style=width:10px>" . $row1['created_at'] . "</td>";
                             echo "<td>" . $row1['name'] . "</td>";
                              echo "<td>" . $row2['Name'] . "</td>";
                               echo "<td style=width:100px>" . $row1['total_pages'] . "</td>";echo "<td>".$row1['decr']."</td>";
                               // echo "<td>".$row1['docc']."</td>";
                                   if($row3['user_type']=='Faculty')
                              {    
                                echo "<td style=width:15%><iframe src='../Faculty/".$rowdid['department']."/". $row3['uname']."/".date('Y')."/Books/Documents/". $row1['docc']."' style=width:100%></iframe></td>";
                              }
                              elseif($row3['user_type']=='Admin')
                              {
                                 echo "<td style=width:15%><iframe src='../admin/Books/".date('Y')."/". $row1['docc']. "' style=width:100%></iframe></td>";
                              }
                              ?>
                              <td class="project-actions text-left">
                                <a class="btn btn-info btn-sm" href="abook.php?bookid=<?php echo $row1['bookid']?>"><i class="fas fa-pencil-alt"></i></a>

...
$ar=mysqli_query($link,"SELECT * FROM user WHERE aid=".$session_aid)or die('Error In Session');
$a=mysqli_fetch_array($ar);
...
if(isset($_GET["eid"])){
    ...
    $sql = "SELECT * FROM addemployee WHERE eid = $eid";
              ...
              <div class="card-body">
                            ...
                            <!-- text input -->
                               <div class="form-group">
                                  <label>Mobile Number:</label>
                                   <?php echo $rows['mno']; ?>
                                 <!--  <input type="text" class="form-control" placeholder="Enter ..." name="mno"> -->
                               </div>
                  </div>
                  <div class="col-sm-3">
                            <div class="form-group">
                  ...
                  <div class="col-sm-6">
                     <div class="form-group">
                                <label for="InputEmail1">Address</label>
                                 <?php echo $rows['addr']; ?>
                                <!-- <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter email" name="addr"> -->
                              </div>
                  </div>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label>Designation</label>
                       <?php echo $rows['desig']; ?>
                     <!--  <input type="text" class="form-control" placeholder="Enter ..." name="desig"> -->
                ...
                <div class="row">
                  <div class="col-sm-6">
                            ...
                            <td style="width:50px;"><input type="submit" class="btn btn-info" name="addemployee" value="submit"></td>
                    ...
                    <table id="Acc" class="table table-bordered projects" style="table-layout: fixed; width: 100%; border-collapse: collapse ;">
                      ...
                      <tr>
                         ...
                         <tr>
                          ...
                          <td style="width:30%">
                           <?php echo $rows['hschool']; ?>
                          </td>
                          <td style="width:30%">
                          <?php echo $rows['hyear']; ?>
                          </td>
                          <td style="width:30%">
                            <?php echo $rows['hresult']; ?>
                          </td>
                         ...
                         <tr>
                          ...
                          <td style="width:30%">
                           <?php echo $rows['sdiploma']; ?>
                          </td>
                          <td style="width:30%">
                           <?php echo $rows['ydiploma']; ?>
                          </td>
                          <td style="width:30%">
                            <?php echo $rows['rdiploma']; ?>
                          </td>
                         ...
                         <tr>
                          <td style="width:30%">
                            <label>Degree</label>
                               ...
                               <td style="width:30%">
                            <?php echo $rows['degreespec']; ?>
                          </td>   
                          <td style="width:30%">
                           <?php echo $rows['degree']; ?>
                          </td>
                          <td style="width:30%">
                           <?php echo $rows['ydegree']; ?>
                          </td>
                          <td style="width:30%">
                           <?php echo $rows['rdegree']; ?>
                          </td>
                        ...
                        <tr>
                          <td style="width:30%">
                           ...
                           <label>Others</label>
                           <td style="width:30%">
                            <?php echo $rows['otherspec']; ?>
                          </td> 
                          <td style="width:30%">
                           <?php echo $rows['sothers']; ?>
                          </td>
                          <td style="width:30%">
                           <?php echo $rows['yothers']; ?>
                          </td>
                          <td style="width:30%">
                           <?php echo $rows['rothers']; ?>
                          </td>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <table id="work" class="table table-bordered projects" style="table-layout: fixed; width: 100%; border-collapse: collapse ;">
                        ...
                        <tbody>
                           <?php 
                            $sql="select * from addexp where eid='$rows[eid]'";
                            if($result = mysqli_query($link, $sql))
                              {
                  ...
                  <div class="col-sm-12">
                      ...
                      <tbody>
                        <tr>
                          <!-- <td > 1</td> -->
                          <td >
                            <img style="width:100px;height:80px;" src='images/<?php echo $rows['profile']; ?>'>
                            <!-- <input type="file" name="profile" class="btn btn-info btn-block file" multiple> -->
                         </td>
                          <td >
                            <?php echo $rows['resume']; ?>
                           <!--  <input type="file" name="resume" class="btn btn-info btn-block file" multiple> -->
                         </td>
                          <td >
                             <?php echo $rows['pass']; ?>
                            <!-- <input type="text" class="form-control" placeholder="Enter...." name="pass"> -->
                          </td>

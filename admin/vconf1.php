                          ...
                          while($row1 = mysqli_fetch_array($result)){
                            ...
                            // echo "<td>" . $row1['conid'] . "</td>";
                             ...
                             echo "<td>" . $row1['name'] . "</td>";
                              ...
                              echo "<td class=col-md-0>" . $row1['start_time'] . "</td>";
                              echo "<td>" . $row1['end_time'] . "</td>";
                               if($row2['user_type']=='Faculty')
                              {
                               echo "<td><img style=width:100px;height:80px; src='../Faculty/".$rowdid['department']."/". $row2['uname']."/".date('Y')."/Conference/Photos/". $row1['photos']. "'/></td>";
                             }
                            elseif($row2['user_type']=='Admin'){
                              echo "<td><img style=width:100px;height:80px; src='../admin/Conference/".date('Y')."/". $row1['photos']. "'/></td>";
                            }
                              ?>

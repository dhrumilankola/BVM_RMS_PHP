  ...
  ob_start();
    ...
    class PDF extends FPDF
    {
        function Header()
        {
			...
			$this->Cell(50,10,"Aca_Year",1,0,'C',true);
            $this->Cell(50,10,"Type Of Work",1,0,'C',true);
            $this->Cell(80,10," Name",1,1,'C',true);   
...
while($row_con=mysqli_fetch_assoc($result))
    {
       $pdf->Cell(14,10,$i,1,0,$row_con['id'],true);
		$pdf->Cell(50,10, $row_con['ay'].'-' .$row_con['ey'],1,0,'C',true);
        $pdf->Cell(50,10,$row_con['typeofwork'],1,0,'C',true);
        $pdf->Cell(80,10, $row_con['name'],1,1,'C',true);
...
<head>
  ...
  <title>BRMS |Admin View HOD Reports </title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="report_HOD.php" class="nav-link active ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>HOD Report</p>
                </a>
              </li>
                ...
                <div class="row">
                 ...
                 <div class="col-sm-3">
                          <div class="form-group">
                              <label> Staff</label>
                            <?php
                              $sql = "SELECT * FROM user where user_type='HOD'";

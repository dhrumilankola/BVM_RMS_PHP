...
//             }
  ...
  if(empty($error)){
     $pdfs = implode("|", $imageData);
      $query="INSERT INTO papers (title,aid,decr,pdf)
VALUES ('$ptitle','$session_aid','$decr','$pdfs')";
              ...
              <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter ..." name="ptitle" required>
                    </div>
                  </div>

...
if(isset($_POST['updatedep'])){
    ...
    $department=$_POST['department'];
     $sql= "UPDATE department SET department='$department' WHERE did='$did'";
      
        if(mysqli_query($link, $sql))
        {
            echo "<script>alert('Edit Department Successfully');</script>";
              header('location:vdepartment.php');
        }
          else
            header('location:adep.php');
...
<head>
  ...
  <title>Birla Vishvakarma Mahavidyalaya | Department</title>
              ...
              <div class="row">
                   ...
                   <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter ..." name="department" value="<?php echo $department; ?>">
                    </div>
                </div>

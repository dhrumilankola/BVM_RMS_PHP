          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">View Papers</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
              <div class="row">
               ...
               <?php  
                    ...
                    if($row3['user_type']=='Faculty')
                              {  
                               echo "<iframe src='../Faculty/".$rowdid['department']."/". $row3['uname']."/".date('Y')."/Papers/Documents/". $row1['pdf'] . "' style=width:80%></iframe>";
                             }
                             elseif($row3['user_type']=='Admin')
                             {
                               echo "<iframe src='../admin/Papers/".date('Y')."/". $row1['pdf']. "' style=width:20%></iframe>";
                             }
